...
(function (root, factory) {
  ...
  GMaps.staticMapURL = function (options) {
    var parameters = [],
      data,
      static_root =
        (location.protocol === 'file:' ? 'http:' : location.protocol) + '//maps.googleapis.com/maps/api/staticmap';
      ...
      for (var p = 0; p < numPaths; p++) {
        ...
        for (var i = 0; i < numPoints; i++) {
          ...
          if (
            ...
            if (
              vertex1.lat() +
                ((latLng.lng() - vertex1.lng()) / (vertex2.lng() - vertex1.lng())) * (vertex2.lat() - vertex1.lat()) <
              latLng.lat()
            ) {
              inPoly = !inPoly;
            }
