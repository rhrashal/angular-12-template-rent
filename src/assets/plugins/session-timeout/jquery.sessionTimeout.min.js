!(function (e) {
  ...
  e.sessionTimeout = function (t) {
    ...
    function n() {
      clearTimeout(a),
        e('#session-timeout-dialog').hasClass('in') || (!d.countdownMessage && !d.countdownBar) || s('dialog', !0),
        (a = setTimeout(function () {
    ...
    function s(t, o) {
      clearTimeout(l.timer),
        'dialog' === t && o
          ...
          : 'session' === t && o && (l.timeLeft = Math.floor(d.redirAfter / 1e3)),
        d.countdownBar && 'dialog' === t
          ? (l.percentLeft = Math.floor((l.timeLeft / ((d.redirAfter - d.warnAfter) / 1e3)) * 100))
          : d.countdownBar &&
            'session' === t &&
            (l.percentLeft = Math.floor((l.timeLeft / (d.redirAfter / 1e3)) * 100));
    ...
    if ('function' != typeof d.onWarn) {
      var u = d.countdownMessage
          ? '<p>' + d.countdownMessage.replace(/{timer}/g, '<span class="countdown-holder"></span>') + '</p>'
          : '',
        c = d.countdownBar
          ? '<div class="progress progress-lg">                   <div class="progress-bar progress-bar-success countdown-bar active" role="progressbar" style="min-width: 15px; width: 100%;">                     <span class="countdown-holder"></span>                   </div>                 </div>'
          : '';
      e('body').append(
