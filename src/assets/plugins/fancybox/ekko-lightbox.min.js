...
(function () {
  ...
  (a = jQuery),
    (b = function (b, c) {
      var d, e, f;
      return (
        (this.options = a.extend({ title: null, footer: null, remote: null }, a.fn.ekkoLightbox.defaults, c || {})),
        (this.$element = a(b)),
        (d = ''),
        ...
        this.modal
          ...
          .on(
            ...
            (function (b) {
              return function () {
                return (
                  b.gallery && a(document).off('keydown.ekkoLightbox'), b.modal.remove(), b.options.onHidden.call(b)
                );
              };
            })(this)
          )
    ...
    (b.prototype = {
          ...
          ? ((this.gallery = this.$element.data('gallery')),
            this.gallery &&
              ('document.body' === this.options.gallery_parent_selector || '' === this.options.gallery_parent_selector
                ? (this.gallery_items = a(document.body).find('*[data-gallery="' + this.gallery + '"]'))
            ...
            this.options.type
              ? 'image' === this.options.type
                ...
                : 'youtube' === this.options.type && (b = this.getYoutubeId(this.options.remote))
      ...
      getYoutubeId: function (a) {
        var b;
        return (
          (b = a.match(/^.*(youtu.be\/|v\/|u\/\w\/|embed\/|watch\?v=|\&v=)([^#\&\?]*).*/)),
      ...
      detectRemoteType: function (a, b) {
        ...
        return (
          ...
          'image' === b || this.isImage(a)
            ...
            : 'video' === b
            ? ((this.options.type = 'video'), this.showVideoIframe(a))
      ...
      showYoutubeVideo: function (a) {
        var b, c, d;
        return (
          (c = null != this.$element.attr('data-norelated') || this.options.no_related ? '&rel=0' : ''),
          (d = this.checkDimensions(this.$element.data('width') || 560)),
          (b = d / (560 / 315)),
          this.showVideoIframe('//www.youtube.com/embed/' + a + '?badge=0&autoplay=1&html5=1' + c, d, b)
        );
      },
      ...
      loadRemoteContent: function (b) {
        ...
        return (
          ...
          c || this.isExternal(b)
            ? (this.lightbox_body.html(
                '<iframe width="' + d + '" height="' + d + '" src="' + b + '" frameborder="0" allowfullscreen></iframe>'
              ),
              this.options.onContentLoaded.call(this))
      ...
      isExternal: function (a) {
        ...
        return (
          ...
          'string' == typeof b[1] && b[1].length > 0 && b[1].toLowerCase() !== location.protocol
            ...
            : 'string' == typeof b[2] &&
              b[2].length > 0 &&
              b[2].replace(new RegExp(':(' + { 'http:': 80, 'https:': 443 }[location.protocol] + ')?$'), '') !==
                location.host
        );
      },
      error: function (a) {
            ...
            ((d.onload = (function (b) {
              return function () {
                ...
                return (
                  ...
                  c.load(function () {
                    return (
                      b.options.scale_height ? b.scaleHeight(d.height, d.width) : b.resize(d.width),
      ...
      scaleHeight: function (b, c) {
        var d, e, f, g, h, i;
        return (
          (g = this.modal_header.outerHeight(!0) || 0),
          (f = this.modal_footer.outerHeight(!0) || 0),
          this.modal_footer.is(':visible') || (f = 0),
          this.modal_header.is(':visible') || (g = 0),
          (d = this.border.top + this.border.bottom + this.padding.top + this.padding.bottom),
          (h = parseFloat(this.modal_dialog.css('margin-top')) + parseFloat(this.modal_dialog.css('margin-bottom'))),
          (i = a(window).height() - d - h - g - f),
          (e = Math.min(i / b, 1)),
          this.modal_dialog.css('height', 'auto').css('max-height', i),
          this.resize(e * c)
        );
      },
      resize: function (b) {
        var c;
        return (
          (c = b + this.border.left + this.padding.left + this.padding.right + this.border.right),
      ...
      checkDimensions: function (a) {
        var b, c;
        return (
          (c = a + this.border.left + this.padding.left + this.padding.right + this.border.right),
