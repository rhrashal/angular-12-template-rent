        ...
        C = (function () {
          ...
          return (
            ...
            (C._slide = function (e, n) {
              ...
              if ((e === h ? ((i = v), (s = E), (r = u)) : ((i = p), (s = T), (r = f)), c && t(c).hasClass(g)))
                this._isSliding = !1;
                ...
                if ((e._clearMenus(), !s)) {
                  ...
                  if ((t(i).trigger(o), !o.isDefaultPrevented())) {
                    if (!this._inNavbar) {
                      ...
                      var a = this._element;
                      t(i).hasClass(g) && (t(this._menu).hasClass(E) || t(this._menu).hasClass(v)) && (a = i),
                        'scrollParent' !== this._config.boundary && t(i).addClass(T),
                    ...
                    'ontouchstart' in document.documentElement &&
                      ...
                      t(i).toggleClass(_).trigger(t.Event(f.SHOWN, r));
                  }
                }
              }
            }),
                    ...
                    if (
                      ...
                      t(r).trigger(c),
                        c.isDefaultPrevented() ||
                          ...
                          t(h).removeClass(_),
                          t(r).removeClass(_).trigger(t.Event(f.HIDDEN, l)));
                    }
                  }
                }
            }),
            ...
            (e._dataApiKeydownHandler = function (n) {
              if (
                (/input|textarea/i.test(n.target.tagName)
                  ? !(
                      32 === n.which ||
                      (27 !== n.which && ((40 !== n.which && 38 !== n.which) || t(n.target).closest(I).length))
                    )
                  : c.test(n.which)) &&
                (n.preventDefault(), n.stopPropagation(), !this.disabled && !t(this).hasClass(d))
              ) {
                var i = e._getParentFromElement(this),
                  s = t(i).hasClass(_);
                if ((s || (27 === n.which && 32 === n.which)) && (!s || (27 !== n.which && 32 !== n.which))) {
                  var r = t(i).find(D).get();
                  if (0 !== r.length) {
        ...
        D = (function () {
          ...
          return (
            ...
            (l.show = function () {
              ...
              if (this.isWithContent() && this._isEnabled) {
                ...
                P.supportsTransitionEnd() && t(this.tip).hasClass(p)
                  ? t(this.tip).one(P.TRANSITION_END, u).emulateTransitionEnd(e._TRANSITION_DURATION)
                  : u();
              }
            }),
            (l.hide = function (e) {
              var n = this,
                ...
                r = function () {
                  n._hoverState !== _ && i.parentNode && i.parentNode.removeChild(i),
                    n._cleanTipClass(),
            ...
            (l.setContent = function () {
              ...
              this.setElementContent(e.find(E), this.getTitle()), e.removeClass(p + ' ' + v);
            }),
            ...
            (e._jQueryInterface = function (n) {
              return this.each(function () {
                ...
                if (
                  ...
                  (i || ((i = new e(this, s)), t(this).data(o, i)), 'string' == typeof n)
                ) {
                  if ('undefined' == typeof i[n]) throw new TypeError('No method named "' + n + '"');
                  i[n]();
                }
    ...
    x = (function (t) {
      var e = 'popover',
        ...
        g = (function (r) {
          ...
          (g = r), ((o = m).prototype = Object.create(g.prototype)), (o.prototype.constructor = o), (o.__proto__ = g);
          var p = m.prototype;
          return (
            ...
            (m._jQueryInterface = function (e) {
              return this.each(function () {
                ...
                if (
                  ...
                  (i || ((i = new m(this, s)), t(this).data(n, i)), 'string' == typeof e)
                ) {
