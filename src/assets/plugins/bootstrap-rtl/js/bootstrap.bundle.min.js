...
!(function (t, e) {
  ...
  for (
    var o,
      ...
      P =
          ...
          return (
            (e.toggle = function () {
              ...
              if (n) {
                ...
                if (i) {
                  if ('radio' === i.type)
                    if (i.checked && g(this._element).hasClass(T)) t = !1;
                    else {
                      var r = g(n).find(A)[0];
                      r && g(r).removeClass(T);
                    }
              ...
              e && this._element.setAttribute('aria-pressed', !g(this._element).hasClass(T)),
        ...
        g(document)
          .on(O.CLICK_DATA_API, w, function (t) {
            t.preventDefault();
            var e = t.target;
            g(e).hasClass(b) || (e = g(e).closest(S)), N._jQueryInterface.call(g(e), 'toggle');
          })
      ...
      R = (function (t) {
          ...
          b = (function () {
            function s(e, n) {
              (this._items = null),
                ...
                (this._element = t(e)[0]),
                (this._indicatorsElement = t(this._element).find(T.INDICATORS)[0]),
            ...
            return (
              ...
              (b.pause = function (e) {
                e || (this._isPaused = !0),
                  t(this._element).find(T.NEXT_PREV)[0] &&
              ...
              (b.to = function (e) {
                var n = this;
                this._activeElement = t(this._element).find(T.ACTIVE_ITEM)[0];
              ...
              (b._getItemIndex = function (e) {
                return (this._items = t.makeArray(t(e).parent().find(T.ITEM))), this._items.indexOf(e);
              }),
              ...
              (b._triggerSlideEvent = function (e, n) {
                var i = this._getItemIndex(e),
                  r = this._getItemIndex(t(this._element).find(T.ACTIVE_ITEM)[0]),
                  o = t.Event(d.SLIDE, { relatedTarget: e, direction: n, from: r, to: i });
                return t(this._element).trigger(o), o;
              }),
              (b._setActiveIndicatorElement = function (e) {
                if (this._indicatorsElement) {
                  t(this._indicatorsElement).find(T.ACTIVE).removeClass(g);
                  var n = this._indicatorsElement.children[this._getItemIndex(e)];
                  n && t(n).addClass(g);
                }
              }),
              (b._slide = function (e, n) {
                var i,
                  r,
                  o,
                  s = this,
                  a = t(this._element).find(T.ACTIVE_ITEM)[0],
                  l = this._getItemIndex(a),
                  h = n || (a && this._getItemByDirection(e, a)),
                  p = this._getItemIndex(h),
                  b = Boolean(this._interval);
                if ((e === c ? ((i = v), (r = E), (o = f)) : ((i = _), (r = y), (o = u)), h && t(h).hasClass(g)))
                  this._isSliding = !1;
                else if (!this._triggerSlideEvent(h, o).isDefaultPrevented() && a && h) {
                  (this._isSliding = !0), b && this.pause(), this._setActiveIndicatorElement(h);
        ...
        return (
          t(document).on(d.CLICK_DATA_API, T.DATA_SLIDE, b._dataApiClickHandler),
          t(window).on(d.LOAD_DATA_API, function () {
            t(T.DATA_RIDE).each(function () {
              var e = t(this);
          ...
          (t.fn[e].noConflict = function () {
            return (t.fn[e] = s), b._jQueryInterface;
          }),
          b
        );
      })(e),
    ...
    if (H && navigator.userAgent.indexOf(M[W]) >= 0) {
      j = 1;
      break;
    }
  var U =
  ...
  function pt(t, e, n) {
    return (
      (void 0 === n
        ...
        t.enabled &&
          B(n) &&
          ((e.offsets.popper = rt(e.offsets.popper)), (e.offsets.reference = rt(e.offsets.reference)), (e = n(e, t)));
      }),
      e
    );
  }
      ...
      modifiers: {
        ...
        applyStyle: {
          ...
          fn: function (t) {
            var e, n;
            return (
              Tt(t.instance.popper, t.styles),
              (e = t.instance.popper),
              (n = t.attributes),
              Object.keys(n).forEach(function (t) {
                !1 !== n[t] ? e.setAttribute(t, n[t]) : e.removeAttribute(t);
              }),
              t.arrowElement && Object.keys(t.arrowStyles).length && Tt(t.arrowElement, t.arrowStyles),
              t
            );
          },
          onLoad: function (t, e, n, i, r) {
            ...
            return e.setAttribute('x-placement', s), Tt(e, { position: 'absolute' }), n;
          },
  ...
  var Nt = (function (t) {
      var e,
        ...
        w =
          (((e = {})[c ? 'TOPEND' : 'TOP'] = 'top-start'),
          (e[c ? 'TOP' : 'TOPEND'] = 'top-end'),
          (e[c ? 'BOTTOMEND' : 'BOTTOM'] = 'bottom-start'),
          (e[c ? 'BOTTOM' : 'BOTTOMEND'] = 'bottom-end'),
          (e[c ? 'LEFT' : 'RIGHT'] = 'right-start'),
          (e[c ? 'LEFTEND' : 'RIGHTEND'] = 'right-end'),
          (e[c ? 'RIGHT' : 'LEFT'] = 'left-start'),
          (e[c ? 'RIGHTEND' : 'LEFTEND'] = 'left-end'),
          e),
        I = { offset: 0, flip: !0, boundary: 'scrollParent' },
        D = { offset: '(number|string|function)', flip: 'boolean', boundary: '(string|element)' },
        A = (function () {
          function e(t, e) {
            (this._element = t),
              (this._popper = null),
          ...
          return (
                ...
                if ((e._clearMenus(), !i)) {
                  ...
                  if ((t(n).trigger(o), !o.isDefaultPrevented())) {
                    if (!this._inNavbar) {
                      ...
                      var s = this._element;
                      t(n).hasClass(d) && (t(this._menu).hasClass(_) || t(this._menu).hasClass(m)) && (s = n),
                        'scrollParent' !== this._config.boundary && t(n).addClass(v),
                        (this._popper = new Ot(s, this._menu, this._getPopperConfig()));
                    }
                    'ontouchstart' in document.documentElement &&
                      0 === t(n).closest(b).length &&
                      t('body').children().on('mouseover', null, t.noop),
                      this._element.focus(),
                      this._element.setAttribute('aria-expanded', !0),
                      t(this._menu).toggleClass(u),
                      t(n).toggleClass(u).trigger(t.Event(h.SHOWN, r));
                  }
                }
              }
            }),
            ...
            (a._getConfig = function (e) {
              return (
                ...
                k.typeCheckConfig(n, e, this.constructor.DefaultType),
                e
              );
            }),
            ...
            (a._getPlacement = function () {
              ...
              return (
                e.hasClass(d)
                  ? ((n = w.TOP), t(this._menu).hasClass(m) && (n = w.TOPEND))
                  : e.hasClass(p)
                  ? (n = w.RIGHT)
                  : e.hasClass(g)
                  ? (n = w.LEFT)
                  : t(this._menu).hasClass(m) && (n = w.BOTTOMEND),
                n
              );
            }),
            ...
            (e._jQueryInterface = function (n) {
              return this.each(function () {
                var i = t(this).data(o);
                if (
                  (i || ((i = new e(this, 'object' == typeof n ? n : null)), t(this).data(o, i)), 'string' == typeof n)
                ) {
            ...
            (e._clearMenus = function (n) {
              if (!n || (3 !== n.which && ('keyup' !== n.type || 9 === n.which)))
                for (var i = t.makeArray(t(E)), r = 0; r < i.length; r++) {
                    ...
                    if (
                      ...
                      t(s).trigger(f),
                        f.isDefaultPrevented() ||
                          ...
                          t(c).removeClass(u),
                          t(s).removeClass(u).trigger(t.Event(h.HIDDEN, l)));
                    }
                  }
                }
            }),
            ...
            (e._dataApiKeydownHandler = function (n) {
              if (
                (/input|textarea/i.test(n.target.tagName)
                  ? !(
                      32 === n.which ||
                      (27 !== n.which && ((40 !== n.which && 38 !== n.which) || t(n.target).closest(T).length))
                    )
                  : l.test(n.which)) &&
                (n.preventDefault(), n.stopPropagation(), !this.disabled && !t(this).hasClass(f))
              ) {
                var i = e._getParentFromElement(this),
                  r = t(i).hasClass(u);
                if ((r || (27 === n.which && 32 === n.which)) && (!r || (27 !== n.which && 32 !== n.which))) {
                  var o = t(i).find(C).get();
                  if (0 !== o.length) {
      ...
      return (
        t(document)
          .on(h.KEYDOWN_DATA_API, E, A._dataApiKeydownHandler)
          .on(h.KEYDOWN_DATA_API, T, A._dataApiKeydownHandler)
          .on(h.CLICK_DATA_API + ' ' + h.KEYUP_DATA_API, A._clearMenus)
          .on(h.CLICK_DATA_API, E, function (e) {
            e.preventDefault(), e.stopPropagation(), A._jQueryInterface.call(t(this), 'toggle');
          })
          .on(h.CLICK_DATA_API, y, function (t) {
            t.stopPropagation();
          }),
        (t.fn[n] = A._jQueryInterface),
        (t.fn[n].Constructor = A),
        (t.fn[n].noConflict = function () {
          return (t.fn[n] = a), A._jQueryInterface;
        }),
        A
      );
    })(e),
    ...
    Lt = (function (t) {
      var e,
        ...
        f =
          (((e = { AUTO: 'auto', TOP: 'top' })[c ? 'LEFT' : 'RIGHT'] = 'right'),
          (e.BOTTOM = 'bottom'),
          (e[c ? 'RIGHT' : 'LEFT'] = 'left'),
          e),
        u = {
        ...
        w = (function () {
          ...
          return (
            ...
            (a.toggle = function (e) {
              if (this._isEnabled)
                if (e) {
                  ...
                  if (t(this.getTipElement()).hasClass(_)) return void this._leave(null, this);
            ...
            (a.show = function () {
              ...
              if (this.isWithContent() && this._isEnabled) {
                ...
                t(o).data(this.constructor.DATA_KEY, this),
                  ...
                  (this._popper = new Ot(this.element, o, {
                    placement: l,
                    modifiers: {
                ...
                k.supportsTransitionEnd() && t(this.tip).hasClass(m)
                  ? t(this.tip).one(k.TRANSITION_END, h).emulateTransitionEnd(e._TRANSITION_DURATION)
                  : h();
              }
            }),
            (a.hide = function (e) {
            ...
            (a.setContent = function () {
              ...
              this.setElementContent(e.find(v), this.getTitle()), e.removeClass(m + ' ' + _);
            }),
            ...
            (a._setListeners = function () {
              ...
              this.config.trigger.split(' ').forEach(function (n) {
                if ('click' === n)
                  ...
                  var i = n === y ? e.constructor.Event.MOUSEENTER : e.constructor.Event.FOCUSIN,
                    r = n === y ? e.constructor.Event.MOUSELEAVE : e.constructor.Event.FOCUSOUT;
                  t(e.element)
            ...
            (a._enter = function (e, n) {
              ...
              (n = n || t(e.currentTarget).data(i)) ||
                ...
                e && (n._activeTrigger['focusin' === e.type ? T : y] = !0),
                t(n.getTipElement()).hasClass(_) || n._hoverState === d
                  ? (n._hoverState = d)
            ...
            (a._leave = function (e, n) {
              ...
              (n = n || t(e.currentTarget).data(i)) ||
                ((n = new this.constructor(e.currentTarget, this._getDelegateConfig())), t(e.currentTarget).data(i, n)),
                e && (n._activeTrigger['focusout' === e.type ? T : y] = !1),
            ...
            (a._getConfig = function (e) {
              return (
                'number' == typeof (e = r({}, this.constructor.Default, t(this.element).data(), e)).delay &&
            ...
            (e._jQueryInterface = function (n) {
              return this.each(function () {
                ...
                if (
                  ...
                  (i || ((i = new e(this, r)), t(this).data(o, i)), 'string' == typeof n)
                ) {
                  if ('undefined' == typeof i[n]) throw new TypeError('No method named "' + n + '"');
                  i[n]();
                }
      ...
      return (
        ...
        (t.fn[n].noConflict = function () {
          return (t.fn[n] = a), w._jQueryInterface;
        }),
        w
      );
    })(e),
