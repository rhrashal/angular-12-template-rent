  ...
  Chart.controllers.line = Chart.DatasetController.extend({
      ...
      if (showLine) {
        ...
        line._model = {
          ...
          cubicInterpolationMode: custom.cubicInterpolationMode
            ...
            : helpers.valueOrDefault(dataset.cubicInterpolationMode, lineElementOptions.cubicInterpolationMode),
        };
    ...
    updateElement: function (point, index, reset) {
      ...
      point._model = {
        ...
        pointStyle:
          custom.pointStyle || helpers.valueAtIndexOrDefault(dataset.pointStyle, index, pointOptions.pointStyle),
        ...
        // Tooltip
        hitRadius:
          custom.hitRadius || helpers.valueAtIndexOrDefault(dataset.pointHitRadius, index, pointOptions.hitRadius),
      };
    },
