              ...
              tooltips: {
                callbacks: {
                  ...
                  label: function (tooltipItem, data) {
                    ...
                    return (
                      datasetLabel + ': (' + tooltipItem.xLabel + ', ' + tooltipItem.yLabel + ', ' + dataPoint.r + ')'
                    );
                  },
                },
              },
                ...
                helpers.extend(point, {
                  ...
                  _model: {
                    ...
                    hitRadius: custom.hitRadius
                      ? custom.hitRadius
                      : helpers.getValueAtIndexOrDefault(dataset.hitRadius, index, pointElementOptions.hitRadius),
                  },
                });
            ...
            Chart.controllers.doughnut = Chart.controllers.pie = Chart.DatasetController.extend({
              ...
              update: function (reset) {
                ...
                if (circumference < Math.PI * 2.0) {
                  ...
                  var contains0 =
                    (startAngle <= 0 && 0 <= endAngle) || (startAngle <= Math.PI * 2.0 && Math.PI * 2.0 <= endAngle);
                  var contains90 =
            ...
            Chart.controllers.line = Chart.DatasetController.extend({
                ...
                if (showLine) {
                  ...
                  line._model = {
                    ...
                    tension: custom.tension
                      ? custom.tension
                      : helpers.getValueOrDefault(dataset.lineTension, lineElementOptions.tension),
                    backgroundColor: custom.backgroundColor
                      ? custom.backgroundColor
                    ...
                    steppedLine: custom.steppedLine
                      ? custom.steppedLine
                      : helpers.getValueOrDefault(dataset.steppedLine, lineElementOptions.stepped),
              ...
              updateElement: function (point, index, reset) {
                ...
                point._model = {
                  ...
                  // Appearance
                  radius:
                    custom.radius || helpers.getValueAtIndexOrDefault(dataset.pointRadius, index, pointOptions.radius),
                  pointStyle:
                    custom.pointStyle ||
                    helpers.getValueAtIndexOrDefault(dataset.pointStyle, index, pointOptions.pointStyle),
                  ...
                  hitRadius:
                    custom.hitRadius ||
                    helpers.getValueAtIndexOrDefault(dataset.pointHitRadius, index, pointOptions.hitRadius),
                };
              },
              ...
              setHoverStyle: function (point) {
                ...
                model.borderWidth =
                  custom.hoverBorderWidth ||
                  helpers.getValueAtIndexOrDefault(dataset.pointHoverBorderWidth, index, model.borderWidth);
              },
              ...
              removeHoverStyle: function (point) {
                ...
                model.radius =
                  custom.radius ||
                  helpers.getValueAtIndexOrDefault(dataset.pointRadius, index, me.chart.options.elements.point.radius);
            ...
            Chart.controllers.radar = Chart.DatasetController.extend({
              ...
              updateElement: function (point, index, reset) {
                ...
                helpers.extend(point, {
                  ...
                  _model: {
                    ...
                    tension: custom.tension
                      ? custom.tension
                      : helpers.getValueOrDefault(dataset.lineTension, me.chart.options.elements.line.tension),
                    radius: custom.radius
                      ? custom.radius
                      : helpers.getValueAtIndexOrDefault(dataset.pointRadius, index, pointElementOptions.radius),
                    backgroundColor: custom.backgroundColor
                      ? custom.backgroundColor
                      : helpers.getValueAtIndexOrDefault(
                          dataset.pointBackgroundColor,
                    ...
                    pointStyle: custom.pointStyle
                      ? custom.pointStyle
                      : helpers.getValueAtIndexOrDefault(dataset.pointStyle, index, pointElementOptions.pointStyle),
              ...
              removeHoverStyle: function (point) {
                ...
                model.radius = custom.radius
                  ? custom.radius
                  : helpers.getValueAtIndexOrDefault(dataset.radius, index, pointElementOptions.radius);
                model.backgroundColor = custom.backgroundColor
                  ? custom.backgroundColor
                  : helpers.getValueAtIndexOrDefault(
                      dataset.pointBackgroundColor,
                ...
                model.borderColor = custom.borderColor
                  ? custom.borderColor
                  : helpers.getValueAtIndexOrDefault(dataset.pointBorderColor, index, pointElementOptions.borderColor);
                model.borderWidth = custom.borderWidth
                  ? custom.borderWidth
                  : helpers.getValueAtIndexOrDefault(dataset.pointBorderWidth, index, pointElementOptions.borderWidth);
              },
            });
          };
        },
                ...
                helpers.each(
                  ...
                  function (value, key) {
                    if (key[0] === '_') {
                      ...
                      var startVal =
                        me._start[key] !== undefined && isNaN(me._start[key]) === false ? me._start[key] : 0;
            ...
            Chart.Scale = Chart.Element.extend({
              ...
              getPixelForTick: function (index, includeOffset) {
                ...
                if (me.isHorizontal()) {
                  ...
                  var tickWidth =
                    innerWidth / Math.max(me.ticks.length - (me.options.gridLines.offsetGridLines ? 0 : 1), 1);
              ...
              draw: function (chartArea) {
                ...
                if (isHorizontal) {
                  ...
                  if (
                    (longestRotatedLabel + optionTicks.autoSkipPadding) * me.ticks.length >
            ...
            var DatasetScale = Chart.Scale.extend({
              ...
              getPixelForValue: function (value, index, datasetIndex, includeOffset) {
                ...
                var offsetAmt = Math.max(
                  me.maxIndex + 1 - me.minIndex - (me.options.gridLines.offsetGridLines ? 0 : 1),
                  1
                );
          ...
          module.exports = function (Chart) {
            ...
            var TimeScale = Chart.Scale.extend({
                        ...
                        function (value) {
                          ...
                          if (labelMoment.isValid()) {
                            ...
                            if (datasetVisible) {
                              ...
                              me.firstTick =
                                me.firstTick !== null ? moment.min(me.firstTick, labelMoment) : labelMoment;
                ...
                if (me.options.time.unit) {
                  ...
                  while (unitDefinitionIndex < time.units.length) {
                    ...
                    if (
                      ...
                      Math.ceil(me.scaleSizeInUnits / labelCapacity) < helpers.max(unitDefinition.steps)
                    ) {
                      ...
                      Math.ceil(me.scaleSizeInUnits / labelCapacity) < unitDefinition.maxStep
                    ) {
                      ...
                      me.scaleSizeInUnits =
                        me.lastTick.diff(me.firstTick, me.tickUnit, true) + leadingUnitBuffer + trailingUnitBuffer;
              ...
              getLabelForIndex: function (index, datasetIndex) {
                var me = this;
                var label =
                  me.chart.data.labels && index < me.chart.data.labels.length ? me.chart.data.labels[index] : '';
