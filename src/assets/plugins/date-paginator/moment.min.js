...
!(function (a, b) {
  ...
  function k(a) {
    if (null == a._isValid) {
      ...
      (a._isValid =
        ...
        !b.userInvalidated),
        a._strict &&
          (a._isValid = a._isValid && 0 === b.charsLeftOver && 0 === b.unusedTokens.length && void 0 === b.bigHour);
    }
    return a._isValid;
  }
  function l(a) {
  ...
  function V(a, b) {
    ...
    return 'string' == typeof b && ((b = a.localeData().monthsParse(b)), 'number' != typeof b)
      ? a
      : ((c = Math.min(a.date(), R(a.year(), b))), a._d['set' + (a._isUTC ? 'UTC' : '') + 'Month'](b, c), a);
  }
  function W(b) {
      ...
      c &&
        ...
        ((b =
          c[cd] < 0 || c[cd] > 11
            ...
            ? dd
            : c[ed] < 0 || c[ed] > 24 || (24 === c[ed] && (0 !== c[fd] || 0 !== c[gd] || 0 !== c[hd]))
            ? ed
            : c[fd] < 0 || c[fd] > 59
            ? fd
            : c[gd] < 0 || c[gd] > 59
  ...
  function ba(b) {
    ...
    return null !== c
      ...
      : (aa(b), void (b._isValid === !1 && (delete b._isValid, a.createFromInputFallback(b))));
  }
  ...
  function sa(a) {
    ...
    (b = a._w),
      null != b.GG || null != b.W || null != b.E
        ? ((f = 1), (g = 4), (c = pa(b.GG, a._a[bd], ha(Aa(), 1, 4).year)), (d = pa(b.W, 1)), (e = pa(b.E, 1)))
        : ((f = a._locale._week.dow),
          (g = a._locale._week.doy),
          (c = pa(b.gg, a._a[bd], ha(Aa(), f, g).year)),
          (d = pa(b.w, 1)),
          null != b.d ? ((e = b.d), f > e && ++d) : (e = null != b.e ? b.e + f : f)),
      (h = na(c, d, e, g, f)),
      (a._a[bd] = h.year),
  ...
  function Ia(b, c) {
    var e, f;
    return c._isUTC
      ? ((e = c.clone()), (f = (o(b) || d(b) ? +b : +Aa(b)) - +e), e._d.setTime(+e._d + f), a.updateOffset(e, !1), e)
      : Aa(b).local();
  ...
  function Va(a, b) {
    ...
    return (
      Fa(a)
        ...
        : (h = ud.exec(a))
        ? ((c = '-' === h[1] ? -1 : 1),
          (g = { y: 0, d: p(h[dd]) * c, h: p(h[ed]) * c, m: p(h[fd]) * c, s: p(h[gd]) * c, ms: p(h[hd]) * c }))
        : (h = vd.exec(a))
        ? ((c = '-' === h[1] ? -1 : 1),
          (g = {
            y: Wa(h[2], c),
        ...
        : 'object' == typeof g &&
          ('from' in g || 'to' in g) &&
          ((e = Ya(Aa(g.from), Aa(g.to))), (g = {}), (g.ms = e.milliseconds), (g.M = e.months)),
      (d = new Ea(g)),
  ...
  function Za(a, b) {
    return function (c, d) {
      ...
      return (
        null === d ||
          isNaN(+d) ||
          (_(b, 'moment().' + b + '(period, number) is deprecated. Please use moment().' + b + '(number, period).'),
          (f = c),
          (c = d),
          (d = f)),
  ...
  function eb(a, b) {
    ...
    return (
      ...
      'millisecond' === b
        ? ((a = o(a) ? a : Aa(a)), +this === +a)
        : ((c = +Aa(a)), +this.clone().startOf(b) <= c && c <= +this.clone().endOf(b))
    );
  }
  function fb(a) {
  ...
  function gb(a, b, c) {
    ...
    return (
      ...
      'year' === b || 'month' === b || 'quarter' === b
        ? ((e = hb(this, f)), 'quarter' === b ? (e /= 3) : 'year' === b && (e /= 12))
        : ((d = this - f),
          (e =
            'second' === b
              ? d / 1e3
  ...
  function sc(a) {
    ...
    if (((a = z(a)), 'month' === a || 'year' === a))
      return (b = this._days + d / 864e5), (c = this._months + 12 * qc(b)), 'month' === a ? c : c / 12;
