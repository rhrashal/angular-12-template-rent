    ...
    (o.prototype = {
      ...
      _init: function (e) {
        (this.options = t.extend({}, o.defaults, e)),
          this.options.width
            ...
            : ((this.options.width = this.$element.width()), (this.options.fillWidth = !0)),
          'string' == typeof this.options.startDate &&
            (this.options.startDate = moment(this.options.startDate, this.options.startDateFormat)
              .clone()
              .startOf('day')),
          ...
          'string' == typeof this.options.selectedDate &&
            (this.options.selectedDate = moment(this.options.selectedDate, this.options.selectedDateFormat)
              .clone()
              .startOf('day')),
      ...
      _subscribeEvents: function () {
        this._unsubscribeEvents(),
          ...
          this.options.fillWidth && t(e).on('resize', t.proxy(this._resize, this));
      },
      _destroy: function () {
        this.initialized &&
      ...
      _setSelectedDate: function (t) {
        t.isSame(this.options.selectedDate) ||
          ...
          ((this.options.selectedDate = t.startOf('day')), this.$element.trigger('selectedDateChanged', [t.clone()]));
      },
      _back: function () {
        ...
        this.initialized
          ...
          : (this.$element
            ...
            (this.$leftNav = t(this._template.navItem)
              ...
              .addClass('sm' === this.options.size ? 'dp-nav-sm' : 'lg' === this.options.size ? 'dp-nav-lg' : '')
              .addClass(this.options.squareEdges ? 'dp-nav-square-edges' : '')
              .append(t(this._template.icon).addClass('ti-angle-left').addClass('dp-nav-left'))
              .width(this.options.navItemWidth)),
            (this.$rightNav = t(this._template.navItem)
              .addClass('dp-nav-right')
              .addClass('sm' === this.options.size ? 'dp-nav-sm' : 'lg' === this.options.size ? 'dp-nav-lg' : '')
              .addClass(this.options.squareEdges ? 'dp-nav-square-edges' : '')
              .append(t(this._template.icon).addClass('ti-angle-right').addClass('dp-nav-right'))
              .width(this.options.navItemWidth)),
            (this.$calendar = this.options.showCalendar ? t(this._template.calendar) : s),
            this._injectStyle(),
            (this.initialized = !0));
        var i = this._buildData();
        this.$element.empty().append(this.$wrapper.empty()),
          this.$leftNav.removeClass('dp-no-select').attr('title', ''),
          i.isSelectedStartDate && this.$leftNav.addClass('dp-no-select').attr('title', 'Start of valid date range'),
          ...
          t.each(i.items, function (i, s) {
            ...
            s.isSelected && e.options.highlightSelectedDate && a.addClass('dp-selected'),
              s.isToday && e.options.highlightToday && a.addClass('dp-today'),
              s.isStartOfWeek && e.options.showStartOfWeek && a.addClass('dp-divider'),
              s.isOffDay && e.options.showOffDays && a.addClass('dp-off'),
              s.isSelected && e.options.showCalendar && a.append(e.$calendar),
              'sm' === e.options.size ? a.addClass('dp-item-sm') : 'lg' === e.options.size && a.addClass('dp-item-lg'),
          ...
          i.isSelectedEndDate && this.$rightNav.addClass('dp-no-select').attr('title', 'End of valid date range'),
          ...
          this.$calendar &&
            ...
            this.$calendar.on('changeDate', t.proxy(this._calendarSelect, this)));
      },
      _injectStyle: function () {
        this.options.injectStyle &&
          !i.getElementById('bootstrap-datepaginator-style') &&
          t('<style type="text/css" id="bootstrap-datepaginator-style">' + this._css + '</style>').appendTo('head');
      },
      _buildData: function () {
        for (
          var t =
              this.options.width -
              (this.options.selectedItemWidth - this.options.itemWidth + 2 * this.options.navItemWidth),
          ...
          var h =
            (r.isSame(this.options.startDate) || r.isAfter(this.options.startDate)) &&
          ...
          p.items[p.items.length] = {
            ...
            isStartOfWeek:
              -1 !== this.options.startOfWeek.split(',').indexOf(r.format(this.options.startOfWeekFormat)) ? !0 : !1,
