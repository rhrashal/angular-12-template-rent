...
(function (t, n) {
    ...
    function e(e) {
      ...
      (w = w.merge(w.enter().insert('path', '.tick').attr('class', 'domain').attr('stroke', '#000'))),
        ...
        b
          ...
          .attr('text-anchor', t === Pf ? 'start' : t === Rf ? 'end' : 'middle'),
        b.each(function () {
          this.__axis = x;
        });
    }
  ...
  function R(t, n, e, r, i, o, u) {
    var a,
      ...
      p = new Array(l);
    for (a = 0; a < l; ++a)
      (c = n[a]) && ((p[a] = s = ol + u.call(c, c.__data__, a, n)), s in f ? (i[a] = c) : (f[s] = c));
    for (a = 0; a < h; ++a)
      (s = ol + u.call(t, o[a], a, o)),
        (c = f[s]) ? ((r[a] = c), (c.__data__ = o[a]), (f[s] = null)) : (e[a] = new P(t, o[a]));
  ...
  function Nt(t) {
    ...
    return (
      ...
      (n = jl.exec(t))
        ? ((n = parseInt(n[1], 16)),
          new zt(((n >> 8) & 15) | ((n >> 4) & 240), ((n >> 4) & 15) | (240 & n), ((15 & n) << 4) | (15 & n), 1))
        : (n = Xl.exec(t))
        ? St(parseInt(n[1], 16))
        : (n = $l.exec(t))
  ...
  function un(t) {
    return 'none' === t
      ? Oh
      : (_h || ((_h = document.createElement('DIV')), (yh = document.documentElement), (gh = document.defaultView)),
        (_h.style.transform = t),
        (t = gh.getComputedStyle(yh.appendChild(_h), null).getPropertyValue('transform')),
        yh.removeChild(_h),
        (t = t.slice(7, -1).split(',')),
  ...
  function an(t) {
    return null == t
      ? Oh
      : (mh || (mh = document.createElementNS('http://www.w3.org/2000/svg', 'g')),
        mh.setAttribute('transform', t),
        (t = mh.transform.baseVal.consolidate()) ? ((t = t.matrix), Fh(t.a, t.b, t.c, t.d, t.e, t.f)) : Oh);
  }
  function cn(t, n, e, r) {
    function i(t) {
    ...
    function a(t, n, e, o) {
      t !== n ? o.push({ i: e.push(i(e) + 'skewX(', null, r) - 2, x: Ch(t, n) }) : n && e.push(i(e) + 'skewX(' + n + r);
    }
  ...
  function Tn(t) {
    if (!Jh) {
      ...
      var n = t - ep;
      n > 24
        ? (t < 1 / 0 && (Qh = setTimeout(bn, n)), Kh && (Kh = clearInterval(Kh)))
  ...
  function En(t, n, e) {
    ...
    function i(r) {
      ...
      for (s in c)
        if (((h = c[s]), h.name === e.name)) {
          ...
          h.state === dp
            ? ((h.state = _p), h.timer.stop(), h.on.call('interrupt', t, t.__data__, h.index, h.group), delete c[s])
      ...
      if (
        ...
        for (e.state = pp, a = new Array((l = e.tween.length)), s = 0, f = -1; s < l; ++s)
    ...
    function o(n) {
      for (
        var r = n < e.duration ? e.ease.call(null, n / e.duration) : (e.timer.restart(u), (e.state = vp), 1),
          i = -1,
          o = a.length;
        ++i < o;
  ...
  function Un(t, n, e) {
    ...
    return function () {
      ...
      return null == a
        ...
        : ((u = this.getAttribute(t)), u === a ? null : u === r && a === i ? o : (o = n((r = u), (i = a))));
    };
  }
  function Dn(t, n, e) {
    var r, i, o;
  ...
  function Me(t, n) {
    for (var e; !(e = t.__transition) || !(e = e[n]); ) if (!(t = t.parentNode)) return (sd.time = _n()), sd;
    return e;
  }
  function Te() {
    t.event.stopImmediatePropagation();
    ...
    function u() {
      ...
      function o() {
        ...
        switch (((m = O[0] - D[0]), (x = O[1] - D[1]), N)) {
          case yd:
          case _d:
            S && ((m = Math.max(P - l, Math.min(R - v, m))), (h = l + m), (_ = v + m)),
              E && ((x = Math.max(L - p, Math.min(q - y, x))), (d = p + x), (g = y + x));
            break;
          case gd:
            S < 0
              ? ((m = Math.max(P - l, Math.min(R - l, m))), (h = l + m), (_ = v))
              : S > 0 && ((m = Math.max(P - v, Math.min(R - v, m))), (h = l), (_ = v + m)),
              E < 0
                ? ((x = Math.max(L - p, Math.min(q - p, x))), (d = p + x), (g = y))
                : E > 0 && ((x = Math.max(L - y, Math.min(q - y, x))), (d = p), (g = y + x));
            break;
          case md:
            S && ((h = Math.max(P, Math.min(R, l - m * S))), (_ = Math.max(P, Math.min(R, v + m * S)))),
              E && ((d = Math.max(L, Math.min(q, p - x * E))), (g = Math.max(L, Math.min(q, y + x * E))));
        }
        _ < h &&
          ((S *= -1),
          (t = l),
      ...
      function a() {
        switch (t.event.keyCode) {
          ...
          case 18:
            N === gd &&
              (S && ((v = _ - m * S), (l = h + m * S)), E && ((y = g - x * E), (p = d + x * E)), (N = md), o());
            break;
          case 32:
            (N !== gd && N !== md) ||
              (S < 0 ? (v = _ - m) : S > 0 && (l = h - m),
      ...
      function s() {
        switch (t.event.keyCode) {
          ...
          case 32:
            N === yd &&
              (t.event.altKey
                ? (S && ((v = _ - m * S), (l = h + m * S)), E && ((y = g - x * E), (p = d + x * E)), (N = md))
                : (S < 0 ? (v = _) : S > 0 && (l = h), E < 0 ? (y = g) : E > 0 && (p = d), (N = gd)),
              Y.attr('cursor', Md[k]),
              o());
            break;
          default:
  ...
  function Dr(t, n) {
    ...
    if (o_) {
      ...
      f ^ (c * e_ < s && s < c * t)
        ? (u = o[1] * C_) > n_ && (n_ = u)
        : ((s = ((s + 360) % 360) - 180),
          f ^ (c * e_ < s && s < c * t) ? (u = -o[1] * C_) < Kv && (Kv = u) : (n < Kv && (Kv = n), n > n_ && (n_ = n))),
        f
          ? t < e_
  ...
  function Gr(t, n) {
    ...
    var e = q_(n),
      ...
      o = I_(n),
      u = R_(
        B_((u = w_ * o - M_ * i) * u + (u = M_ * r - b_ * o) * u + (u = b_ * i - w_ * r) * u),
        b_ * r + w_ * i + M_ * o
      );
  ...
  function ai(t, n, e, r, i, o) {
    if (e) {
      ...
      null == i
        ? ((i = n + r * A_), (o = n - c / 2))
        : ((i = ci(u, i)), (o = ci(u, o)), (r > 0 ? i < o : i > o) && (i += r * A_));
    ...
    return function (u) {
      ...
      function d(o, u) {
        ...
        if ((_ && y.push([o, u]), T)) (g = o), (m = u), (x = a), (T = !1), a && (N.lineStart(), N.point(o, u));
          ...
          gy(c, s, t, n, e, r)
            ? (M || (N.lineStart(), N.point(c[0], c[1])), N.point(s[0], s[1]), a || N.lineEnd(), (k = !1))
  ...
  function Ti() {
    ...
    return (
      ...
      (t.precision = function (n) {
        return arguments.length
          ? ((g = +n), (f = wi(a, u, 90)), (l = Mi(r, e, g)), (h = wi(s, c, 90)), (p = Mi(o, i, g)), t)
          : g;
      }),
      t
        .extentMajor([
    ...
    function e(r, i, o, u, a, c, s, f, l, h, p, d, v, _) {
      ...
      if (m > 4 * n && v--) {
        var x = u + h,
          ...
          C = E - i,
          z = g * A - y * C;
        ((z * z) / m > n || P_((y * A + g * C) / m - 0.5) > 0.3 || u * h + a * p + c * d < dg) &&
  ...
  function ro(t) {
    ...
    return (
      ...
      (n.clipExtent = function (t) {
        return arguments.length
          ? ((S =
              null == t
                ? ((N = l = h = p = null), Uy)
                : li((N = +t[0][0]), (l = +t[0][1]), (h = +t[1][0]), (p = +t[1][1]))),
            o())
          : null == N
          ? null
          : [
      ...
      (n.rotate = function (t) {
        return arguments.length
          ? ((b = (t[0] % 360) * z_), (w = (t[1] % 360) * z_), (M = t.length > 2 ? (t[2] % 360) * z_ : 0), i())
          : [b * C_, w * C_, M * C_];
      }),
  ...
  function lu(t, n, e, r, i, o) {
    for (
      var u, a, c, s, f, l, h, p, d, v, _, y = [], g = n.children, m = 0, x = 0, b = g.length, w = n.value;
      m < b;
      ...
      for (l = h = f, v = Math.max(s / c, c / s) / (w * t), _ = f * f * v, d = Math.max(h / _, _ / l); x < b; ++x) {
        if (
          ((f += a = g[x].value), a < l && (l = a), a > h && (h = a), (_ = f * f * v), (p = Math.max(h / _, _ / l)) > d)
        ) {
          f -= a;
          break;
        }
      ...
      y.push((u = { value: f, dice: c < s, children: g.slice(m, x) })),
        u.dice ? Jg(u, e, r, i, w ? (r += (s * f) / w) : o) : im(u, e, r, w ? (e += (c * f) / w) : i, o),
        (w -= f),
        (m = x);
    }
    return y;
  ...
  function yu(t, n) {
    return function (e, r) {
      t._tasks[n] &&
        ...
        ++t._ended,
        (t._tasks[n] = null),
        null == t._error && (null != e ? gu(t, e) : ((t._data[n] = r), t._waiting ? vu(t) : mu(t))));
    };
  }
  function gu(t, n) {
    var e,
    ...
    return (
      ...
      (t.nice = function (e) {
        ...
        return (
          ...
          (i = r(c, s, e)),
          i > 0
            ? ((c = Math.floor(c / i) * i), (s = Math.ceil(s / i) * i), (i = r(c, s, e)))
            : i < 0 && ((c = Math.ceil(c * i) / i), (s = Math.floor(s * i) / i), (i = r(c, s, e))),
          i > 0
            ? ((o[u] = Math.floor(c / i) * i), (o[a] = Math.ceil(s / i) * i), n(o))
            : i < 0 && ((o[u] = Math.ceil(c * i) / i), (o[a] = Math.floor(s * i) / i), n(o)),
          t
        );
      }),
      t
    ...
    function n(t, n) {
      return function (e) {
        ...
        for (e instanceof Date || (e = new Date(+e)); ++a < s; )
          37 === t.charCodeAt(a) &&
            (u.push(t.slice(c, a)),
            null != (i = Vx[(r = t.charAt(++a))]) ? (r = t.charAt(++a)) : (i = 'e' === r ? ' ' : '0'),
            (o = n[r]) && (r = o(e, i)),
            u.push(r),
            (c = a + 1));
  ...
  function ec(t, n, e, r, o, u, a, c, s) {
    function f(i) {
      return (
        a(i) < i ? v : u(i) < i ? _ : o(i) < i ? y : r(i) < i ? g : n(i) < i ? (e(i) < i ? m : x) : t(i) < i ? b : w
      )(i);
    }
    function l(n, e, r, o) {
    ...
    return (
      ...
      (h.ticks = function (t, n) {
        var e,
          ...
          u = o < i;
        return (
          u && ((e = i), (i = o), (o = e)), (e = l(t, i, o, n)), (e = e ? e.range(i, o + 1) : []), u ? e.reverse() : e
        );
      }),
  ...
  function pc(t, n, e, r, i, o, u) {
    ...
    return (
      ...
      { cx: T, cy: k, x01: -f, y01: -l, x11: T * (i / b - 1), y11: k * (i / b - 1) }
    );
  }
  function dc(t) {
    this._context = t;
  ...
  function wc(t) {
    function n() {
      ...
      if (
        (u || (u = n = Ue()),
        t(u, +i.apply(this, ((a[0] = c), a)), +o.apply(this, a), +i.apply(this, ((a[0] = s), a)), +o.apply(this, a)),
        n)
      )
  ...
  function jc(t, n, e) {
    var r = t._x1 - t._x0,
      ...
      u = (e - t._y1) / (i || (r < 0 && -0)),
      a = (o * i + u * r) / (r + i);
    return (Hc(o) + Hc(u)) * Math.min(Math.abs(o), Math.abs(u), 0.5 * Math.abs(a)) || 0;
  }
  function Xc(t, n) {
    var e = t._x1 - t._x0;
      ...
      if (((o = r - c), d || !(o < 0))) {
        ...
        if (((o = e - s), v || !(o > 0))) {
          ...
          if (((o = i - s), v || !(o < 0))) {
            ...
            return (
              !(h > 0 || p < 1) ||
              (h > 0 && (t[0] = [c + h * d, s + h * v]), p < 1 && (t[1] = [c + p * d, s + p * v]), !0)
            );
          }
        }
      }
  ...
  function ys(t, n, e, r) {
    for (var i, o = Yw.length; o--; )
      (_s((i = Yw[o]), t, n, e, r) &&
        vs(i, t, n, e, r) &&
        (Math.abs(i[0][0] - i[1][0]) > jw || Math.abs(i[0][1] - i[1][1]) > jw)) ||
        delete Yw[o];
  }
  function gs(t) {
  ...
  function Ms(t, n, e, r) {
    ...
    if (y) {
      ...
      for (i = 0, y = null; i < _; ++i)
        (o = Fw[i]) && ((u = o.site), (g = u[0] - t), (m = u[1] - n), (x = g * g + m * m) < b && ((b = x), (y = o)));
      if (y) {
        var w = [t, n],
          M = [t, r],
          T = [e, r],
  ...
  function Cs(t) {
    var n = t.circle,
      ...
      a = [t];
    As(t);
    for (var c = o; c.circle && Math.abs(e - c.circle.x) < jw && Math.abs(r - c.circle.cy) < jw; )
      (o = c.P), a.unshift(c), As(c), (c = o);
    a.unshift(c), Ns(c);
    for (var s = u; s.circle && Math.abs(e - s.circle.x) < jw && Math.abs(r - s.circle.cy) < jw; )
  ...
  function zs(t) {
    ...
    if ((Ow.insert(n, c), n || e)) {
      if (n === e)
        return Ns(n), (e = Es(n.site)), Ow.insert(c, e), (c.edge = e.edge = hs(n.site, c.site)), ks(n), void ks(e);
  ...
  function Us(t, n) {
    ...
    for (Yw = [], Fw = new Array(t.length), Ow = new as(), Iw = new as(); ; )
      if (((i = Dw), o && (!i || o[1] < i.y || (o[1] === i.y && o[0] < i.x))))
        (o[0] === e && o[1] === r) || (zs(o), (e = o[0]), (r = o[1])), (o = t.pop());
      else {
        if (!i) break;
        Cs(i.arc);
      }
  ...
  var js = function (t, n) {
    ...
    Ks = function (t, n) {
      var e,
        ...
        a = 0,
        c = 0;
      if (null == n) for (; ++u < i; ) isNaN((e = Qs(t[u]))) || ((r = e - a), (a += r / ++o), (c += r * (e - a)));
      else for (; ++u < i; ) isNaN((e = Qs(n(t[u], u, t)))) || ((r = e - a), (a += r / ++o), (c += r * (e - a)));
      if (o > 1) return c / (o - 1);
    },
    tf = function (t, n) {
      var e = Ks(t, n);
    ...
    _f = function (t, n, e) {
      return (
        ...
        Math.ceil((e - n) / (2 * (vf(t, 0.75) - vf(t, 0.25)) * Math.pow(t.length, -1 / 3)))
      );
    },
    yf = function (t, n, e) {
        ...
        u = o.length;
      {
        ...
        if (a)
          for (var c, s = 0, f = a.length; s < f; ++s)
            for (r = 0, c = a[s]; r < u; ++r) if ((i = o[r]).type === c.type && i.name === c.name) return c.value;
      }
    },
    Wf = function () {
  ...
  var il = function (t) {
    ...
    cl = function (t) {
      for (
        var n = this._groups, e = t._groups, r = n.length, i = e.length, o = Math.min(r, i), u = new Array(r), a = 0;
        a < o;
        ++a
      )
    ...
    yl = function (t, n) {
      ...
      return this.each(
        (null == n ? (e.local ? D : U) : 'function' == typeof n ? (e.local ? Y : I) : e.local ? F : O)(e, n)
      );
    },
    gl = function (t) {
    ...
    ml = function (t, n, e) {
      return arguments.length > 1
        ? this.each((null == n ? B : 'function' == typeof n ? j : H)(t, n, null == e ? '' : e))
        : X(this.node(), t);
    },
    xl = function (t, n) {
  ...
  var Pl = function (t) {
    ...
    Rl = function (t, n, e) {
      ...
      for (var r, i = 0, o = n ? n.length : 0; i < o; ++i) if ((r = n[i]).identifier === e) return Zf(t, r);
      return null;
    },
    ql = function (t, n) {
      null == n && (n = Wf().touches);
  ...
  var Fl = function () {
      ...
      function e() {
        if (!h && p.apply(this, arguments)) {
          ...
          n &&
            (Pl(t.event.view).on('mousemove.drag', r, !0).on('mouseup.drag', i, !0),
            Dl(t.event.view),
            gt(),
            (l = !1),
            (s = t.event.clientX),
      ...
      function c(e, r, i, o, u) {
        var a,
          ...
          l = g.copy();
        if (
          A(new xt(n, 'beforestart', a, e, m, f[0], f[1], 0, 0, l), function () {
  ...
  Il(kt, Nt, {
    ...
    Il(
      ...
      Tt(kt, {
        brighter: function (t) {
          return (
            (t = null == t ? 1 / 0.7 : Math.pow(1 / 0.7, t)), new zt(this.r * t, this.g * t, this.b * t, this.opacity)
          );
        },
        darker: function (t) {
          return (t = null == t ? 0.7 : Math.pow(0.7, t)), new zt(this.r * t, this.g * t, this.b * t, this.opacity);
        },
        rgb: function () {
          return this;
        },
    ...
    Il(
      ...
      Tt(kt, {
        brighter: function (t) {
          return (t = null == t ? 1 / 0.7 : Math.pow(1 / 0.7, t)), new qt(this.h, this.s, this.l * t, this.opacity);
        },
        darker: function (t) {
          return (t = null == t ? 0.7 : Math.pow(0.7, t)), new qt(this.h, this.s, this.l * t, this.opacity);
        },
        rgb: function () {
  ...
  Il(
    ...
    Tt(kt, {
      brighter: function (t) {
        return (t = null == t ? 1 / 0.7 : Math.pow(1 / 0.7, t)), new Zt(this.h, this.s, this.l * t, this.opacity);
      },
      darker: function (t) {
        return (t = null == t ? 0.7 : Math.pow(0.7, t)), new Zt(this.h, this.s, this.l * t, this.opacity);
      },
      rgb: function () {
  ...
  var _h,
    ...
    Fh = function (t, n, e, r, i, o) {
      ...
      return (
        ...
        { translateX: i, translateY: o, rotate: Math.atan2(n, t) * Dh, skewX: Math.atan(c) * Dh, scaleX: u, scaleY: a }
      );
    },
    Ih = cn(un, 'px, ', 'px)', 'deg)'),
    Yh = cn(an, ', ', ')', ')'),
  ...
  gn.prototype = mn.prototype = {
    ...
    restart: function (t, n, e) {
      ...
      (e = (null == e ? _n() : +e) + (null == n ? 0 : +n)),
        this._next || bh === this || (bh ? (bh._next = this) : (xh = this), (bh = this)),
        (this._call = t),
        (this._time = e),
        Tn();
    },
  ...
  var up = function (t, n, e) {
      ...
      for (var r = this._groups, i = r.length, o = new Array(i), u = 0; u < i; ++u)
        for (var a, c, s = r[u], f = s.length, l = (o[u] = new Array(f)), h = 0; h < f; ++h)
          (a = s[h]) &&
            ...
            ('__data__' in a && (c.__data__ = a.__data__), (l[h] = c), yp(l[h], n, e, h, l, Sn(a, e)));
    ...
    Pp = function (t) {
      ...
      for (var r = this._groups, i = r.length, o = [], u = [], a = 0; a < i; ++a)
        for (var c, s = r[a], f = s.length, l = 0; l < f; ++l)
          if ((c = s[l])) {
            for (var h, p = t.call(c, c.__data__, l, s), d = Sn(c, e), v = 0, _ = p.length; v < _; ++v)
    ...
    qp = function (t, n, e) {
      ...
      return null == n
        ...
        : this.styleTween(t, 'function' == typeof n ? Jn(t, r, zn(this, 'style.' + t, n)) : Gn(t, r, n + ''), e);
    },
    Up = function (t, n, e) {
      var r = 'style.' + (t += '');
  ...
  var ld = [null],
    hd = function (t, n) {
      ...
      if (i) {
        n = null == n ? null : n + '';
        for (r in i) if ((e = i[r]).state > lp && e.name === n) return new ne([[t]], ld, n, +r);
      }
      return null;
    },
    pd = function (t) {
  ...
  var Yd = function () {
    function t() {
      ...
      if (
        ...
        u.moveTo(p, d),
        u.arc(0, 0, f, l, h),
        (l === _ && h === y) || (u.quadraticCurveTo(0, 0, v * Ad(_), v * Cd(_)), u.arc(0, 0, v, _, y)),
  ...
  var Bd = function () {
      function t(n, i, u, a) {
        ...
        for (var c, s, f, l = -1, h = n.length, p = o[i++], d = He(), v = u(); ++l < h; )
        ...
        if (!(!(v = c.node) || (i = c.x0) > h || (o = c.y0) > p || (u = c.x1) < f || (a = c.y1) < l))
          if (v.length) {
            ...
            d.push(
              ...
              (s = ((n >= y) << 1) | (t >= _)) &&
                ((c = d[d.length - 1]), (d[d.length - 1] = d[d.length - 1 - s]), (d[d.length - 1 - s] = c));
          } else {
  ...
  (xv.copy = function () {
    ...
    for (t = [{ source: r, target: (e._root = new Array(4)) }]; (r = t.pop()); )
      for (var i = 0; i < 4; ++i)
        (n = r.source[i]) &&
          (n.length ? t.push({ source: n, target: (r.target[i] = new Array(4)) }) : (r.target[i] = ur(n)));
    return e;
  }),
    (xv.add = av),
    (xv.addAll = tr),
    ...
    Pv = function (t, n) {
      return function (e, r) {
        for (
          ...
          i > 0 &&
          a > 0 &&
          (c + a + 1 > r && (a = Math.max(1, r - c)), o.push(e.substring((i -= a), i + a)), !((c += a + 1) > r));
  ...
  var Fv,
    ...
    Bv = function (t) {
      function n(t) {
        ...
        return (
          (d =
            null == d ? (v ? 6 : 12) : /[gprs]/.test(v) ? Math.max(1, Math.min(21, d)) : Math.max(0, Math.min(20, d))),
          (n.toString = function () {
            return t + '';
          }),
          n
  ...
  var Vv,
    ...
    Q_ = {
      ...
      polygonEnd: function () {
        Z_.polygonEnd(),
          ...
          (Q_.lineStart = Or),
          (Q_.lineEnd = Fr),
          V_ < 0 ? ((Qv = -(t_ = 180)), (Kv = -(n_ = 90))) : J_ > k_ ? (n_ = 90) : J_ < -k_ && (Kv = -90),
          (a_[0] = Qv),
          (a_[1] = t_);
      },
    },
    K_ = function (t) {
      ...
      if (((n_ = t_ = -(Qv = Kv = 1 / 0)), (u_ = []), $_(t, Q_), (e = u_.length))) {
        for (u_.sort(jr), n = 1, r = u_[0], o = [r]; n < e; ++n)
          (i = u_[n]),
            Xr(r, i[0]) || Xr(r, i[1])
              ? (Hr(r[0], i[1]) > Hr(r[0], r[1]) && (r[1] = i[1]), Hr(i[0], r[1]) > Hr(r[0], r[1]) && (r[0] = i[0]))
              : o.push((r = i));
        for (u = -1 / 0, e = o.length - 1, n = 0, r = o[e]; n <= e; r = i, ++n)
          (i = o[n]), (a = Hr(r[1], i[0])) > u && ((u = a), (Qv = i[0]), (t_ = r[1]));
      }
      return (
        (u_ = a_ = null),
        Qv === 1 / 0 || Kv === 1 / 0
    ...
    ny = function (t) {
      ...
      var n = __,
        ...
        i = n * n + e * e + r * r;
      return i < 1e-12 &&
        ((n = p_), (e = d_), (r = v_), s_ < k_ && ((n = f_), (e = l_), (r = h_)), (i = n * n + e * e + r * r) < 1e-12)
        ? [NaN, NaN]
  ...
  var iy,
        ...
        if (((u = i - a), p || !(u < 0))) {
          ...
          if (((u = r - c), d || !(u > 0))) {
            ...
            if (((u = o - c), d || !(u < 0))) {
              ...
              return (
                l > 0 && ((t[0] = a + l * p), (t[1] = c + l * d)), h < 1 && ((n[0] = a + h * p), (n[1] = c + h * d)), !0
              );
            }
          }
        }
    ...
    ky = function (t, n) {
      ...
      for (var a = 0, c = t.length; a < c; ++a)
        if ((f = (s = t[a]).length))
          for (
            var s, f, l = s[f - 1], h = l[0], p = l[1] / 2 + E_, d = I_(p), v = q_(p), _ = 0;
            _ < f;
            ++_, h = g, d = x, v = b, l = y
          ) {
            var y = s[_],
    ...
    Py = {
      ...
      FeatureCollection: function (t, n) {
        for (var e = t.features, r = -1, i = e.length; ++r < i; ) if (_i(e[r].geometry, n)) return !0;
        return !1;
      },
    },
    Ly = {
      ...
      MultiPolygon: function (t, n) {
        for (var e = t.coordinates, r = -1, i = e.length; ++r < i; ) if (mi(e[r], n)) return !0;
        return !1;
      },
      GeometryCollection: function (t, n) {
        for (var e = t.geometries, r = -1, i = e.length; ++r < i; ) if (_i(e[r], n)) return !0;
        return !1;
      },
    },
    Ry = function (t, n) {
      ...
      function i(t) {
        ...
        return {
          ...
          point: function (l, h) {
            ...
            if (
              (!n && (a = i = v) && t.lineStart(),
              v !== i && (!(p = o(n, d)) || my(n, p) || my(d, p)) && ((d[0] += k_), (d[1] += k_), (v = r(d[0], d[1]))),
              v !== i)
            )
              (f = 0),
                v
  ...
  var pg = 16,
    ...
    gg = function () {
      return yg().parallels([29.5, 45.5]).scale(1070).translate([480, 250]).rotate([96, 0]).center([-0.6, 38.7]);
    },
    mg = function () {
      function t(t) {
        var n = t[0],
        ...
        clipExtent: function (i) {
          return arguments.length
            ? ((d =
                null == i
                  ? ((p = n = e = r = null), Uy)
                  : li((p = +i[0][0]), (n = +i[0][1]), (e = +i[1][0]), (r = +i[1][1]))),
              t())
            : null == p
            ? null
            : [
    ...
    em = function () {
      function t(t) {
        ...
        for (i = 0; i < f; ++i)
          (r = t[i]),
            (a = l[i] = new Uo(r)),
            null != (c = n(r, i, t)) && (c += '') && ((s = Kg + (a.id = c)), (h[s] = s in h ? nm : a));
        for (i = 0; i < f; ++i)
  ...
  var rm = function () {
      ...
      function r(t, n, e) {
        if (n) {
          for (
            var r, i = t, u = t, a = n, c = i.parent.children[0], s = i.m, f = u.m, l = a.m, h = c.m;
            (a = ou(a)), (i = iu(i)), a && i;
      ...
      function e(t, e, r, i, o) {
        if ((u = t._squarify) && u.ratio === n)
          for (var u, a, c, s, f, l = -1, h = u.length, p = t.value; ++l < h; ) {
            ...
            a.dice ? Jg(a, e, r, i, (r += ((o - r) * a.value) / p)) : im(a, e, r, (e += ((i - e) * a.value) / p), o),
              (p -= a.value);
          }
  ...
  var Jx = Date.prototype.toISOString ? Qa : t.utcFormat('%Y-%m-%dT%H:%M:%S.%LZ'),
    ...
    yb = function (t) {
      ...
      return (_b.h = 360 * t - 100), (_b.s = 1.5 - 1.5 * n), (_b.l = 0.8 - 0.9 * n), _b + '';
    },
    gb = rc(
      cb(
        ...
        if ((c || (c = t = Ue()), l < f && ((s = l), (l = f), (f = s)), l > Cb))
          if (d > Lb - Cb)
            c.moveTo(l * kb(h), l * Eb(h)),
              c.arc(0, 0, l, h, p, !v),
              f > Cb && (c.moveTo(f * kb(p), f * Eb(p)), c.arc(0, 0, f, p, h, v));
          else {
            var _,
              y,
              g = h,
            ...
            if (k > Cb) {
              var A = uc((k / f) * Eb(T)),
                C = uc((k / l) * Eb(T));
              (w -= 2 * A) > Cb ? ((A *= v ? 1 : -1), (x += A), (b -= A)) : ((w = 0), (x = b = (h + p) / 2)),
                (M -= 2 * C) > Cb ? ((C *= v ? 1 : -1), (g += C), (m -= C)) : ((M = 0), (g = m = (h + p) / 2));
            }
            var z = l * kb(g),
              P = l * Eb(g),
              L = f * kb(b),
            ...
            M > Cb
              ? E > Cb
                ? ((_ = pc(D, O, z, P, l, E, v)),
                  ...
                  E < N
                    ? c.arc(_.cx, _.cy, E, Tb(_.y01, _.x01), Tb(y.y01, y.x01), !v)
                    : (c.arc(_.cx, _.cy, E, Tb(_.y01, _.x01), Tb(_.y11, _.x11), !v),
                      c.arc(0, 0, l, Tb(_.cy + _.y11, _.cx + _.x11), Tb(y.cy + y.y11, y.cx + y.x11), !v),
                      c.arc(y.cx, y.cy, E, Tb(y.y11, y.x11), Tb(y.y01, y.x01), !v)))
              ...
              f > Cb && w > Cb
                ? S > Cb
                  ? ((_ = pc(L, R, q, U, f, -S, v)),
                    ...
                    S < N
                      ? c.arc(_.cx, _.cy, S, Tb(_.y01, _.x01), Tb(y.y01, y.x01), !v)
                      : (c.arc(_.cx, _.cy, S, Tb(_.y01, _.x01), Tb(_.y11, _.x11), !v),
                        c.arc(0, 0, f, Tb(_.cy + _.y11, _.cx + _.x11), Tb(y.cy + y.y11, y.cx + y.x11), v),
                        c.arc(y.cx, y.cy, S, Tb(y.y11, y.x11), Tb(y.y01, y.x01), !v)))
                  : c.arc(0, 0, f, b, x, v)
                : c.lineTo(L, R);
          }
        else c.moveTo(0, 0);
      ...
      function t(t) {
        ...
        for (
          ...
          (c = d[a]),
            (l = v[c]),
            (f = _ + (l > 0 ? l * s : 0) + m),
            (v[c] = { data: t[c], index: a, value: l, startAngle: _, endAngle: f, padAngle: g });
        return v;
      }
      var n = Fb,
        e = Ob,
  ...
  var Bb = function () {
    ...
    fw = function () {
      function t() {
        var t;
        if ((r || (r = t = Ue()), n.apply(this, arguments).draw(r, +e.apply(this, arguments)), t))
  ...
  as.prototype = {
    ...
    insert: function (t, n) {
      ...
      if (t) {
        ...
        this._
          ? ((t = ls(this._)), (n.P = null), (n.N = t), (t.P = t.L = n), (e = t))
        ...
        (r = e.U),
          e === r.L
            ? ((i = r.R),
              i && i.C
                ? ((e.C = i.C = !1), (r.C = !0), (t = r))
                : (t === e.R && (ss(this, e), (t = e), (e = t.U)), (e.C = !1), (r.C = !0), fs(this, r)))
            : ((i = r.L),
              i && i.C
                ? ((e.C = i.C = !1), (r.C = !0), (t = r))
                : (t === e.L && (fs(this, e), (t = e), (e = t.U)), (e.C = !1), (r.C = !0), ss(this, r))),
          (e = t.U);
      this._.C = !1;
    },
    remove: function (t) {
      ...
      if (
        ...
        do {
          ...
          if (t === i.L) {
            if (
              ((n = i.R), n.C && ((n.C = !1), (i.C = !0), ss(this, i), (n = i.R)), (n.L && n.L.C) || (n.R && n.R.C))
            ) {
              (n.R && n.R.C) || ((n.L.C = !1), (n.C = !0), fs(this, n), (n = i.R)),
                (n.C = i.C),
                (i.C = n.R.C = !1),
                ss(this, i),
                (t = this._);
            ...
            ((n = i.L), n.C && ((n.C = !1), (i.C = !0), fs(this, i), (n = i.L)), (n.L && n.L.C) || (n.R && n.R.C))
          ) {
            (n.L && n.L.C) || ((n.R.C = !1), (n.C = !0), ss(this, n), (n = i.L)),
              (n.C = i.C),
              (i.C = n.L.C = !1),
              fs(this, i),
              (t = this._);
          ...
          if ((o = (i = e.halfedges).length))
            for (var i, o, u, a = e.site, c = -1, s = n[i[o - 1]], f = s.left === a ? s.right : s.left; ++c < o; )
              (u = f),
                ...
                u && f && r < u.index && r < f.index && Rs(a, u, f) < 0 && t.push([a.data, u.data, f.data]);
        }),
        t
      );
    },
      ...
      function h() {
        if (g.apply(this, arguments)) {
          ...
          if (_ && ((_ = clearTimeout(_)), !o.touch1))
            return o.end(), void ((i = Pl(this).on('dblclick.zoom')) && i.apply(this, arguments));
          n &&
