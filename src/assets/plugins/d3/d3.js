...
(function (global, factory) {
    ...
    function newFormat(specifier) {
      ...
      function format(value) {
        ...
        if (type === 'c') {
          ...
          // Compute the prefix and suffix.
          valuePrefix =
            (valueNegative ? (sign === '(' ? sign : '-') : sign === '-' || sign === '(' ? '' : sign) + valuePrefix;
          valueSuffix =
            valueSuffix +
  ...
  function projectionMutator(projectAt) {
    ...
    projection.stream = function (stream) {
      return cache && cacheStream === stream
        ? cache
        : (cache = transformRadians(preclip(rotate, projectResample(postclip((cacheStream = stream))))));
    };

    projection.clipAngle = function (_) {
      return arguments.length
        ? ((preclip = +_ ? clipCircle((theta = _ * radians), 6 * radians) : ((theta = null), clipAntimeridian)),
          reset())
        : theta * degrees$1;
    };
      ...
      return arguments.length
        ? ((postclip =
            _ == null
              ...
              : clipExtent((x0 = +_[0][0]), (y0 = +_[0][1]), (x1 = +_[1][0]), (y1 = +_[1][1]))),
          reset())
        : x0 == null
        ? null
        : [
  ...
  var identity$5 = function () {
    ...
    return (projection = {
      ...
      translate: function (_) {
        return arguments.length
          ? ((transform = scaleTranslate(k * sx, k * sy, (tx = +_[0]), (ty = +_[1]))), reset())
          : [tx, ty];
      },
      reflectX: function (_) {
        return arguments.length
          ? ((transform = scaleTranslate(k * (sx = _ ? -1 : 1), k * sy, tx, ty)), reset())
          : sx < 0;
      },
      reflectY: function (_) {
        return arguments.length
          ? ((transform = scaleTranslate(k * sx, k * (sy = _ ? -1 : 1), tx, ty)), reset())
          : sy < 0;
      },
  ...
  function threshold$1() {
    ...
    scale.domain = function (_) {
      return arguments.length
        ? ((domain = slice$4.call(_)), (n = Math.min(domain.length, range$$1.length - 1)), scale)
        : domain.slice();
    };

    scale.range = function (_) {
      return arguments.length
        ? ((range$$1 = slice$4.call(_)), (n = Math.min(domain.length, range$$1.length - 1)), scale)
        : range$$1.slice();
    };
  ...
  function weekday(i) {
    return newInterval(
      ...
      function (start, end) {
        return (
          (end - start - (end.getTimezoneOffset() - start.getTimezoneOffset()) * durationMinute$1) / durationWeek$1
        );
      }
    );
  }
  ...
  var stack = function () {
    ...
    stack.order = function (_) {
      return arguments.length
        ? ((order = _ == null ? none$2 : typeof _ === 'function' ? _ : constant$10(slice$5.call(_))), stack)
        : order;
    };
  ...
  var zoom = function () {
    ...
    function wheeled() {
      ...
      var g = gesture(this, arguments),
        ...
        k = Math.max(
          k0,
          Math.min(k1, t.k * Math.pow(2, (-exports.event.deltaY * (exports.event.deltaMode ? 120 : 1)) / 500))
        ),
        p = mouse(this);
    ...
    zoom.translateExtent = function (_) {
      return arguments.length
        ? ((x0 = +_[0][0]), (x1 = +_[1][0]), (y0 = +_[0][1]), (y1 = +_[1][1]), zoom)
        : [
            [x0, y0],
            [x1, y1],
          ];
