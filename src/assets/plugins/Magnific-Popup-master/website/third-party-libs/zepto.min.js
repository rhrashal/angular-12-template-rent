...
var Zepto = (function () {
  ...
  function T(c, d, e) {
    for (b in d)
      e && (J(d[b]) || K(d[b]))
        ? (J(d[b]) && !J(c[b]) && (c[b] = {}), K(d[b]) && !K(c[b]) && (c[b] = []), T(c[b], d[b], e))
        : d[b] !== a && (c[b] = d[b]);
  }
  function U(b, d) {
    ...
    ($.active = 0),
      ...
      ($.ajax = function (options) {
        ...
        if (
          ...
          (settings.contentType !== !1 && settings.data && settings.type.toUpperCase() != 'GET')
        )
              ...
              if (
                ...
                try {
                  dataType == 'script'
                    ...
                    : dataType == 'json' && (result = blankRE.test(result) ? null : $.parseJSON(result));
                } catch (e) {
                  error = e;
                }
  ...
  (function (a, b) {
    ...
    a.each(g, function (a, e) {
      ...
      (a.fn.animate = function (b, c, d, e) {
        return (
          a.isPlainObject(c) && ((d = c.easing), (e = c.complete), (c = c.duration)),
