  ...
  (st.fn = st.prototype =
    {
      ...
      init: function (e, n, r) {
        ...
        if ('string' == typeof e) {
          if (
            ((i =
              '<' === e.charAt(0) && '>' === e.charAt(e.length - 1) && e.length >= 3 ? [null, e, null] : ft.exec(e)),
            !i || (!i[1] && n))
          )
    ...
    st.extend({
      ...
      ready: function (e) {
        if (e === !0 ? !--st.readyWait : !st.isReady) {
          ...
          (st.isReady = !0),
            (e !== !0 && --st.readyWait > 0) ||
              (U.resolveWith(V, [st]), st.fn.trigger && st(V).trigger('ready').off('ready'));
        }
      },
      ...
      parseJSON: function (n) {
        return e.JSON && e.JSON.parse
          ...
          ? n
          : 'string' == typeof n &&
            ((n = st.trim(n)), n && dt.test(n.replace(gt, '@').replace(mt, ']').replace(ht, '')))
          ? Function('return ' + n)()
            ...
            return r !== L && 9 === r.nodeType && r.documentElement
              ? ((L = r),
                ...
                (W.getByName = o(function (e) {
                  ...
                  var t =
                    r.getElementsByName && r.getElementsByName(P).length === 2 + r.getElementsByName(P + 0).length;
