...
(function () {})(),
  (function () {
      ...
      (t.reduceRight = t.foldr =
        function (a, b, c, d) {
          return (
            a == null && (a = []),
            m && a.reduceRight === m
              ? (d && (b = t.bind(b, d)), c !== void 0 ? a.reduceRight(b, c) : a.reduceRight(b))
              : ((a = (t.isArray(a) ? a.slice() : t.toArray(a)).reverse()), t.reduce(a, b, c, d))
          );
        }),
      (t.find = t.detect =
        function (a, b, c) {
    ...
    (t.include = t.contains =
      ...
      (t.zip = function () {
        for (var a = f.call(arguments), b = t.max(t.pluck(a, 'length')), c = Array(b), d = 0; d < b; d++)
          c[d] = t.pluck(a, '' + d);
        return c;
      }),
  ...
  (function (a) {
        ...
        while ((d = b()) != null)
          if (!a)
            ...
            d != 'u' && p('Expecting UnicodeEscapeSequence -- uXXXX'),
              (d = r()),
              h(d) || p('Unicode char: ' + d.charCodeAt(0) + ' is not valid in identifier'),
              (c += d),
              (a = !1);
        return c;
      }
    ...
    function o(a, b, c) {
      ...
      function f() {
        return (
          (jb.prev = jb.token),
          jb.peeked ? ((jb.token = jb.peeked), (jb.peeked = null)) : (jb.token = jb.input()),
          jb.token
        );
      }
      function g() {
      ...
      function D(a) {
        ...
        return (
          ...
          b != null
            ? (f(), u(b, jb.labels) || h('Label ' + b + ' without matching loop or statement'))
      ...
      function E() {
        ...
        if (!d('punc', ';')) {
          ...
          if (d('operator', 'in'))
            return a[0] == 'var' && a[1].length > 1 && h('Only one variable declaration allowed in for..in loop'), G(a);
        }
        return F(a);
      }
      function F(a) {
      ...
      function J() {
        ...
        return (
          d('keyword', 'finally') && (f(), (c = I())), !b && !c && h('Missing catch/finally blocks'), x('try', a, b, c)
        );
      }
      function K(a) {
        var b = [];
              ...
              switch (q(jb.token.value, f)) {
                ...
                case 'return':
                  return (
                    ...
                    x('return', d('punc', ';') ? (f(), null) : t() ? null : q(ob, w))
                  );
                case 'switch':
  ...
  (function (a) {
    ...
    function c(a) {
      (this.names = {}),
        ...
        (this.parent = a),
        (this.children = []),
        a ? ((this.level = a.level + 1), a.children.push(this)) : (this.level = 0);
    }
    function d(a) {
      function d(a) {
        ...
        if (!c.no_functions) {
          ...
          a &&
            (f
              ...
              ? ((g = {}), !m.uses_eval && !m.uses_with ? (a = g[a] = m.next_mangled()) : (g[a] = a))
              : (a = null));
        }
        return (
          (d = h(
    ...
    function i(a) {
      return (
        ...
        (a[0] == 'binary' && A(a[1], ['in', 'instanceof', '==', '!=', '===', '!==', '<', '<=', '>=', '>'])) ||
      ...
      function g(a) {
        return (
          a != null &&
            a[0] == 'block' &&
            a[1] &&
            (a[1].length == 1 ? (a = a[1][0]) : a[1].length == 0 && (a = ['block'])),
          a
        );
      }
      function k(a, b, c) {
          ...
          (a = (function (b, c) {
            return (
              _(a).forEach(function (a) {
                c && ((a[0] == 'var' && c[0] == 'var') || (a[0] == 'const' && c[0] == 'const'))
                  ? (c[1] = c[1].concat(a[1]))
                  : (b.push(a), (c = a));
              }),
              b
          ...
          c.make_seqs &&
            (a = (function (b, c) {
              return (
                ...
                b.length >= 2 &&
                  b[b.length - 2][0] == 'stat' &&
                  (b[b.length - 1][0] == 'return' || b[b.length - 1][0] == 'throw') &&
                  b[b.length - 1][1] &&
                  b.splice(b.length - 2, 2, [b[b.length - 1][0], ['seq', b[b.length - 2][1], b[b.length - 1][1]]]),
                b
              );
            })([])),
          a
          ...
          b[0] == 'if' && j(b[3]) && j(c)
            ...
            ? c
              ? c[0] == 'stat'
                ...
                : h(c) && (g = p(a, b, c))
              : (g = f(g, ['stat', e(a, b[1])]))
            : c && b[0] == c[0] && (b[0] == 'return' || b[0] == 'throw') && b[1] && c[1]
            ? (g = f(g, [b[0], e(a, b[1], c[1])]))
            : c && h(b)
            ? ((g = [['if', a, b]]), c[0] == 'block' ? c[1] && (g = g.concat(c[1])) : g.push(c), (g = u(['block', g])))
            : b && h(c) && (g = p(a, b, c)),
          g
        );
      }
                ...
                return (
                  (function () {
                    ...
                    var d = u(b),
                      e = u(c);
                    return (
                      d && d[0] == 'unary-prefix' && d[1] == '!' && d[2][0] == 'num'
                        ? (b = ['num', +!d[2][1]])
                        : e && e[0] == 'unary-prefix' && e[1] == '!' && e[2][0] == 'num' && (c = ['num', +!e[2][1]]),
                      ['binary', a, b, c]
                    );
                  })() || this
                );
    ...
    function s(a, c) {
      ...
      function h(a) {
        ...
        for (var c = 0; c < a.length; ++c) {
          ...
          b.push(a[c]),
            d &&
              ((/[a-z0-9_\x24]$/i.test(a[c] + '') && /^[a-z0-9_\x24]/i.test(d + '')) ||
                (/[\+\-]$/.test(a[c] + '') && /^[\+\-]/.test(d + ''))) &&
              b.push(' ');
        }
        return b.join('');
      ...
      function m(a) {
        if (a[0] == 'function' || a[0] == 'object') {
          ...
          while (d) {
            ...
            if (
              ((d[0] != 'seq' && d[0] != 'call' && d[0] != 'dot' && d[0] != 'sub' && d[0] != 'conditional') ||
                d[1] !== c) &&
              ((d[0] != 'binary' && d[0] != 'assign' && d[0] != 'unary-postfix') || d[2] !== c)
            )
              return !1;
            (c = d), (d = b.pop());
          }
      ...
      function n(a) {
        ...
        return (
          Math.floor(a) === a
            ? (a < 0
                ? c.push('-0x' + (-a).toString(16).toLowerCase(), '-0' + (-a).toString(8))
                : c.push('0x' + a.toString(16).toLowerCase(), '0' + a.toString(8)),
              (d = /^(.*?)(0+)$/.exec(a)) && c.push(d[1] + 'e' + d[2].length))
            : (d = /^0?\.(0+)(.*)$/.exec(a)) &&
              c.push(d[2] + 'e-' + (d[1].length + d[2].length), b.substr(b.indexOf('.'))),
          l(c)
        );
      }
      function o(a) {
      ...
      function p(a, b, c, d, f) {
        var g = d || 'function';
        return (
          a && (g += ' ' + e(a)), (g += '(' + i(I(b, e)) + ')'), (g = h([g, E(c)])), !f && m(this) ? '(' + g + ')' : g
        );
      }
      function s(a) {
        switch (a[0]) {
      ...
      return R.with_walkers(
        {
          ...
          binary: function (a, b, d) {
            ...
            return (
              ...
              (d[0] == 'binary' && B[a] >= B[d[1]] && (d[1] != a || !A(a, ['&&', '||', '*'])))
                ? (f = '(' + f + ')')
                : !J &&
                  c.inline_script &&
                  (a == '<' || a == '<<') &&
          ...
          'unary-prefix': function (a, b) {
            var c = S(b);
            return (
              b[0] == 'num' || (b[0] == 'unary-prefix' && !x(C, a + b[1])) || !m(b) || (c = '(' + c + ')'),
              ...
              g(function () {
                return I(a, function (a) {
                  ...
                  return (
                    c.quote_keys
                      ? (b = d(b))
                      : (typeof b == 'number' || (!J && +b + '' == b)) && parseFloat(b) >= 0
                      ? (b = n(+b))
                      : w(b) || (b = d(b)),
          ...
          new: function (a, b) {
            if (a[0] == 'name') {
              if (a[1] == 'Array' && !i.has('Array'))
                return b.length != 1 ? ['array', b] : f(['call', ['name', 'Array'], b]);
              if (a[1] == 'Object' && !i.has('Object'))
                return b.length ? f(['call', ['name', 'Object'], b]) : ['object', []];
              if ((a[1] == 'RegExp' || a[1] == 'Function' || a[1] == 'Error') && !i.has(a[1]))
        ...
        return (
          ...
          k.squeeze &&
            (l = g('squeeze', function () {
              return (
                (l = j.ast_squeeze(l, { make_seqs: k.make_seqs, dead_code: k.dead_code, extra: k.extra })),
