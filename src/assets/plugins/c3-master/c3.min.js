        ...
        switch (q) {
          case 'bottom':
            (A = c),
              ...
              R.attr('x', 0).attr('y', z(Y)).style('text-anchor', w(Y)).attr('transform', x(Y)),
    ...
    return (
      ...
      (k.tickInterval = function () {
        ...
        return (
          b.isCategory
            ? (a = 2 * u)
            : ((c = k.g.select('path.domain').node().getTotalLength() - 2 * l), (a = c / k.g.selectAll('line').size())),
          a === 1 / 0 ? 0 : a
        );
      }),
      (k.ticks = function () {
  ...
  (k.generate = function (a) {
    ...
    (i.updateSizes = function () {
      ...
      (a.currentWidth = a.getCurrentWidth()),
        ...
        a.hasType('gauge') && !b.gauge_fullCircle && (a.arcHeight += a.height - a.getGaugeLabelHeight()),
                ...
                return (
                  d.isCustomX() && d.isCategorized() && 0 === c && !p(j)
                    ? (0 === c && 0 === g && (e.axis_x_categories = []),
                      ...
                      -1 === h && ((h = e.axis_x_categories.length), e.axis_x_categories.push(j)))
    ...
    (i.updateEventRect = function (a) {
      ...
      (a =
        ...
        a.attr('class', h.classEvent.bind(h)).attr('x', b).attr('y', c).attr('width', d).attr('height', e);
    }),
          ...
          ? 'y2' !== a || c.axis_y2_show
            ? ('x' === a &&
              ...
              'y' === a &&
                ...
                (d = 30 + b.axis.getMaxTickWidth(a) * Math.cos((Math.PI * (90 - c.axis_y_tick_rotate)) / 180)),
    ...
    (i.updateTargetsForLine = function (a) {
      ...
      (b = d.main
        ...
        (c = b.enter().append('g').attr('class', f).style('opacity', 0).style('pointer-events', 'none')),
    ...
    (i.updateLine = function (a) {
      ...
      (b.mainLine = b.main
        ...
        b.mainLine.enter().append('path').attr('class', b.classLine.bind(b)).style('stroke', b.color),
        b.mainLine
    ...
    (i.updateBar = function (a) {
      ...
      (b.mainBar = b.main
        ...
        .selectAll('.' + l.bar)
        .data(c)),
        b.mainBar.enter().append('path').attr('class', d).style('stroke', f).style('fill', f),
    ...
    (i.updateTargetsForText = function (a) {
      ...
      (b = d.main
        ...
        (c = b.enter().append('g').attr('class', e).style('opacity', 0).style('pointer-events', 'none')),
    ...
    (i.initGrid = function () {
      var a = this,
        b = a.config,
        c = a.d3;
      (a.grid = a.main.append('g').attr('clip-path', a.clipPathForGrid).attr('class', l.grid)),
        b.grid_x_show && a.grid.append('g').attr('class', l.xgrids),
        b.grid_y_show && a.grid.append('g').attr('class', l.ygrids),
        b.grid_focus_show && a.grid.append('g').attr('class', l.xgridFocus).append('line').attr('class', l.xgridFocus),
        (a.xgrid = c.selectAll([])),
      ...
      if (0 === l.data_groups.length)
        ...
        a.sort(function (a, b) {
          var c = a ? a.value : null,
            d = b ? b.value : null;
          return (
            c > 0 && d > 0 && ((c = a ? q.indexOf(a.id) : null), (d = b ? q.indexOf(b.id) : null)), p ? c - d : d - c
          );
        });
      }
    ...
    (i.hideLegend = function (a) {
      ...
      c.legend_show && u(a) && ((c.legend_show = !1), b.legend.style('visibility', 'hidden')),
        ...
        b.legend.selectAll(b.selectorLegends(a)).style('opacity', 0).style('visibility', 'hidden');
    }),
    ...
    (i.updateLegend = function (a, b, c) {
      ...
      (a = a.filter(function (a) {
        ...
        (r ? v.transition() : v).style('stroke', y.color).attr('x1', m).attr('y1', o).attr('x2', n).attr('y2', o),
    ...
    (f.prototype.getYAxis = function (a, b, c, d, e, f, h) {
      ...
      return (
        i.isTimeSeriesY() ? l.ticks(i.d3.time[j.axis_y_tick_time_value], j.axis_y_tick_time_interval) : l.tickValues(d),
        l
      );
    }),
        ...
        : (h.svg &&
            ...
            'y' === a
              ? ((d = h.y.copy().domain(h.getYDomain(c, 'y'))),
                (e = this.getYAxis(d, h.yOrient, i.axis_y_tick_format, h.yAxisTickValues, !1, !0, !0)))
              : 'y2' === a
              ? ((d = h.y2.copy().domain(h.getYDomain(c, 'y2'))),
                (e = this.getYAxis(d, h.y2Orient, i.axis_y2_tick_format, h.y2AxisTickValues, !1, !0, !0)))
    ...
    (i.initArc = function () {
      ...
      (a.arcs = a.main
        ...
        a.arcs.append('text').attr('class', l.chartArcsTitle).style('text-anchor', 'middle').text(a.getArcTitle());
    }),
      ...
      (d = h
        ...
        e.hasType('gauge') &&
          ...
          e.arcs
            ...
            .attr('dx', -1 * (e.innerRadius + (e.radius - e.innerRadius) / (g.gauge_fullCircle ? 1 : 2)) + 'px')
            .attr('dy', '1.2em')
            .text(g.gauge_label_show ? g.gauge_min : ''),
          e.arcs
            .select('.' + l.chartArcsGaugeMax)
            .attr('dx', e.innerRadius + (e.radius - e.innerRadius) / (g.gauge_fullCircle ? 1 : 2) + 'px')
            .attr('dy', '1.2em')
    ...
    (i.updateLineForSubchart = function (a) {
      ...
      (b.contextLine = b.context
        ...
        .selectAll('.' + l.line)
        .data(b.lineData.bind(b))),
        b.contextLine.enter().append('path').attr('class', b.classLine.bind(b)).style('stroke', b.color),
          ...
          d
            ...
            .call(C, function () {
              ...
              D.attr('transform', null).attr(b.xgridAttr),
                ...
                G.attr('transform', null).attr('x', q).attr('y', r).style('fill-opacity', b.opacityForText.bind(b)),
          ...
          (SVGPathSegList.prototype._parsePath = function (a) {
            ...
            (d.prototype._isCurrentSpace = function () {
              ...
              (d.prototype._nextCommandHelper = function (a, b) {
                return ('+' == a || '-' == a || '.' == a || (a >= '0' && '9' >= a)) && b != SVGPathSeg.PATHSEG_CLOSEPATH
                ...
                if (
                  ...
                  if (this._currentIndex < this._endIndex && '.' == this._string.charAt(this._currentIndex)) {
                    ...
                    for (
                      ...
                      d += (this._string.charAt(this._currentIndex++) - '0') * (c *= 0.1);
                  }
                  if (
                    ...
                    if (
                      ...
                      '+' == this._string.charAt(this._currentIndex)
                        ? this._currentIndex++
                        : '-' == this._string.charAt(this._currentIndex) && (this._currentIndex++, (f = -1)),
                      this._currentIndex >= this._endIndex ||
                        this._string.charAt(this._currentIndex) < '0' ||
                        this._string.charAt(this._currentIndex) > '9')
                    )
