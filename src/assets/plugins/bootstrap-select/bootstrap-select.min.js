  ...
  !(function (a) {
    ...
    function c(a) {
      var b,
        c = [],
        d = a && a.options;
      if (a.multiple) for (var e = 0, f = d.length; e < f; e++) (b = d[e]), b.selected && c.push(b.value || b.text);
      else c = a.value;
      return c;
    }
    function d(a, b, c, d) {
    ...
    a.fn.triggerNative = function (a) {
      var b,
        c = this[0];
      c.dispatchEvent
        ? (l ? (b = new Event(a, { bubbles: !0 })) : ((b = document.createEvent('Event')), b.initEvent(a, !0, !1)),
          c.dispatchEvent(b))
        : c.fireEvent
    ...
    (x.VERSION = '1.13.1'),
      ...
      '4' === t.major &&
        ((x.DEFAULTS.style = 'btn-light'), (x.DEFAULTS.iconBase = ''), (x.DEFAULTS.tickIcon = 'bs-ok-default')),
      (x.prototype = {
        constructor: x,
        init: function () {
          var a = this,
        ...
        createView: function (c, d) {
          function e(a, d) {
            ...
            (f.selectpicker.view.scrollTop = a),
              !0 === t &&
                ...
                (f.sizeInfo.totalMenuWidth = f.sizeInfo.menuWidth + f.sizeInfo.scrollBarWidth),
            ...
            if (
              (void 0 === r && (r = 0),
              (m = [f.selectpicker.view.position0, f.selectpicker.view.position1]),
              (k = Math.max(0, r - 1)),
              (l = Math.min(j - 1, r + 1)),
              (f.selectpicker.view.position0 = Math.max(0, q[k][0]) || 0),
              (f.selectpicker.view.position1 = Math.min(p, q[l][1]) || 0),
              (n = m[0] !== f.selectpicker.view.position0 || m[1] !== f.selectpicker.view.position1),
              void 0 !== f.activeIndex &&
                ((h = f.selectpicker.current.elements[f.selectpicker.current.map.newIndex[f.prevActiveIndex]]),
                (i = f.selectpicker.current.elements[f.selectpicker.current.map.newIndex[f.activeIndex]]),
                (g = f.selectpicker.current.elements[f.selectpicker.current.map.newIndex[f.selectedIndex]]),
                d &&
                  (f.activeIndex !== f.selectedIndex &&
                    (i.classList.remove('active'), i.firstChild && i.firstChild.classList.remove('active')),
              ...
              (d || n) &&
                ((o = f.selectpicker.view.visibleElements ? f.selectpicker.view.visibleElements.slice() : []),
                ...
                f.setOptionStatus(),
                (c || (!1 === t && d)) && (s = !b(o, f.selectpicker.view.visibleElements)),
                (d || !0 === t) && s))
            ) {
              var w,
                x,
              ...
              !0 === t &&
                ((w =
                  0 === f.selectpicker.view.position0
                    ? 0
                    : f.selectpicker.current.data[f.selectpicker.view.position0 - 1].position),
                (x =
              ...
              if (c && d) {
                ...
                f.selectpicker.view.canHighlight[E] || (E = 1 + f.selectpicker.view.canHighlight.slice(1).indexOf(!0)),
                  ...
                  f.selectpicker.view.currentActive &&
                    (f.selectpicker.view.currentActive.classList.remove('active'),
                    f.selectpicker.view.currentActive.firstChild &&
                      f.selectpicker.view.currentActive.firstChild.classList.remove('active')),
          ...
          this.setPositionData(),
            e(d, !0),
            this.$menuInner.off('scroll.createView').on('scroll.createView', function (a, b) {
        ...
        createLi: function () {
          ...
          var n = function (a, b, c, d) {
              ...
              return (
                a && (1 === a.nodeType || 11 === a.nodeType ? e.appendChild(a) : (e.innerHTML = a)),
            ...
            o = function (a, b, c) {
              ...
              return (
                a && (11 === a.nodeType ? d.appendChild(a) : d.insertAdjacentHTML('beforeend', a)),
            ...
            r = function (a) {
              ...
              return (
                a.labelSubtext && ((b = k.subtext.cloneNode(!1)), (b.textContent = a.labelSubtext), e.appendChild(b)),
                m.appendChild(e),
                m
              );
            };
          if (this.options.title && !this.multiple) {
            ...
            if (w) {
              ...
              v =
                void 0 === a(s.options[s.selectedIndex]).attr('selected') && void 0 === this.$element.data('selected');
            }
            ...
            if ((j++, !l.hasClass('bs-title-option'))) {
              ...
              if (!0 === t.hidden || (c.options.hideDisabled && ((H && !F) || G))) {
                ...
                return void (
                  ...
                  (j++, d.push(n(!1, 0, u.DIVIDER, h + 'div')), g.push({ type: 'divider', optID: h, originalIndex: k }))
                );
              }
              if (F && !0 !== t.divider) {
                ...
                if (!this.previousElementSibling) {
                  ...
                  d.push(n(R, 0, 'dropdown-header' + M, h)),
                    g.push({ content: O, subtext: P, type: 'optgroup-label', optID: h, originalIndex: k }),
                    (i = j - 1);
                }
                if ((c.options.hideDisabled && H) || !0 === t.hidden) return void j--;
                (s = q({ text: z, optionContent: y, optionSubtext: B, optionIcon: C })),
                ...
                I &&
                  ...
                  (s = q({ text: z, optionContent: y, optionSubtext: B, optionIcon: C })),
                  d.push(n(o(s, v, w))),
                  g.push({ content: y || z, subtext: B, tokens: A, type: 'option', originalIndex: k, data: t }),
                  e++;
              }
        ...
        render: function () {
          ...
          for (var e = 0, f = this.selectpicker.main.elements.length; e < f; e++) {
            ...
            if (
              h &&
              h.selected &&
              (c.push(h), (d.length < 100 && 'count' !== a.options.selectedTextFormat) || 1 === c.length)
            ) {
              if (
                a.options.hideDisabled &&
                (h.disabled || ('OPTGROUP' === h.parentNode.tagName && h.parentNode.disabled))
              )
                return;
              var i,
                j,
          ...
          if (
            (c.length > 50 && (m += '...'), this.multiple && -1 !== this.options.selectedTextFormat.indexOf('count'))
          ) {
        ...
        liHeight: function (b) {
          if (b || (!1 !== this.options.size && !this.sizeInfo)) {
            ...
            var c = document.createElement('div'),
              ...
              m =
                this.options.header && this.$menu.find('.' + u.POPOVERHEADER).length > 0
            ...
            if (
              ...
              (g.className = 'dropdown-menu inner ' + ('4' === t.major ? u.SHOW : '')),
              ...
              this.selectpicker.view.widestOption && g.appendChild(this.selectpicker.view.widestOption.cloneNode(!0)),
              g.appendChild(j),
              g.appendChild(h),
              g.appendChild(i),
              m && d.appendChild(m),
            ...
            var r,
              ...
              F = {
                vert:
                  E.vert + e(B ? B.marginTop : D.css('marginTop')) + e(B ? B.marginBottom : D.css('marginBottom')) + 2,
                horiz:
                  E.horiz + e(B ? B.marginLeft : D.css('marginLeft')) + e(B ? B.marginRight : D.css('marginRight')) + 2,
              };
        ...
        getSelectPosition: function () {
          ...
          (this.sizeInfo.selectOffsetTop = e.top - b.top - d.scrollTop()),
            (this.sizeInfo.selectOffsetBot =
              d.height() - this.sizeInfo.selectOffsetTop - this.sizeInfo.selectHeight - b.top - g[2]),
            (this.sizeInfo.selectOffsetLeft = e.left - b.left - d.scrollLeft()),
            (this.sizeInfo.selectOffsetRight =
              d.width() - this.sizeInfo.selectOffsetLeft - this.sizeInfo.selectWidth - b.left - g[1]),
        ...
        setMenuSize: function (a) {
          ...
          if (
            (this.options.dropupAuto &&
              ...
              this.$newElement.toggleClass(
                ...
                this.sizeInfo.selectOffsetTop - this.sizeInfo.selectOffsetBot > this.sizeInfo.menuExtras.vert &&
                  h + this.sizeInfo.menuExtras.vert + 50 > this.sizeInfo.selectOffsetBot
              )),
            ...
            (e =
              ...
              this.$newElement.hasClass(u.DROPUP) &&
                (c = this.sizeInfo.selectOffsetTop - this.sizeInfo.menuExtras.vert),
              (f = c),
              (b = c - k - l - m - n - p.vert);
          else if (
            this.options.size &&
          ...
          'auto' === this.options.dropdownAlignRight &&
            ...
            this.$menu.css({ 'max-height': f + 'px', overflow: 'hidden', 'min-height': d + 'px' }),
            this.$menuInner.css({ 'max-height': b + 'px', 'overflow-y': 'auto', 'min-height': g + 'px' }),
          ...
          if ((this.liHeight(b), this.options.header && this.$menu.css('padding-top', 0), !1 !== this.options.size)) {
            ...
            this.setMenuSize(),
              ...
              b
                ...
                : d.multiple ||
                  ('number' == typeof (c = d.selectpicker.main.map.newIndex[d.$element[0].selectedIndex]) &&
                    !1 !== d.options.size &&
                    ((f = d.sizeInfo.liHeight * c),
                    (f = f - d.sizeInfo.menuInnerHeight / 2 + d.sizeInfo.liHeight / 2))),
              d.createView(!1, f);
          }
        },
        setWidth: function () {
        ...
        setSelected: function (a, b, c, d) {
          ...
          c || (c = this.selectpicker.main.map.newIndex[a]),
            ...
            g &&
              (g.classList.toggle('selected', b), g.classList.toggle('active', j), g.setAttribute('aria-selected', b)),
            j ||
              (!h &&
                b &&
                void 0 !== this.prevActiveIndex &&
                ((e = this.selectpicker.main.map.newIndex[this.prevActiveIndex]),
                (f = this.selectpicker.main.elements[e]),
                f.classList.remove('selected'),
                f.classList.remove('active'),
                f.firstChild && (f.firstChild.classList.remove('selected'), f.firstChild.classList.remove('active'))));
        },
        setDisabled: function (a, b, c, d) {
          ...
          c || (c = this.selectpicker.main.map.newIndex[a]),
            ...
            e &&
              ...
              b ? e.setAttribute('tabindex', -1) : e.setAttribute('tabindex', 0));
        },
        isDisabled: function () {
        ...
        checkDisabled: function () {
          ...
          this.isDisabled()
            ? (this.$newElement.addClass(u.DISABLED),
              this.$button.addClass(u.DISABLED).attr('tabindex', -1).attr('aria-disabled', !0))
        ...
        clickListener: function () {
          ...
          d.data('spaceSelect', !1),
            ...
            this.$newElement.on('show.bs.dropdown', function () {
              t.major > 3 &&
                !b.dropdown &&
                ((b.dropdown = b.$button.data('bs.dropdown')), (b.dropdown._menu = b.$menu[0]));
            }),
            this.$button.on('click.bs.dropdown.data-api', function () {
            ...
            this.$menuInner.on('click', 'li a', function (d, e) {
              var f = a(this),
                ...
                l = !0;
              if (
                (b.multiple && 1 !== b.options.maxOptions && d.stopPropagation(),
                d.preventDefault(),
                ...
                if (
                  (h === b.activeIndex && (e = !0),
                  e || ((b.prevActiveIndex = b.activeIndex), (b.activeIndex = void 0)),
                  b.multiple)
                ) {
                    ...
                    if ((q && s) || (r && t))
                      if (q && 1 == q)
                        ...
                        x[2] &&
                          ...
                          q &&
                            s &&
                            (A.append(a('<div>' + y + '</div>')), (l = !1), b.$element.trigger('maxReached.bs.select')),
                          r &&
                            t &&
                ...
                !b.multiple || (b.multiple && 1 === b.options.maxOptions)
                  ...
                  l &&
                    ((i != c(b.$element[0]) && b.multiple) || (j != b.$element.prop('selectedIndex') && !b.multiple)) &&
                    ((k = [h, n.prop('selected'), i]), b.$element.triggerNative('change'));
              }
            }),
            this.$menu.on(
              'click',
              'li.' + u.DISABLED + ' a, .' + u.POPOVERHEADER + ', .' + u.POPOVERHEADER + ' :not(.close)',
              function (c) {
            ...
            this.$searchbox.on('input propertychange', function () {
              ...
              if (
                ...
                for (var e = 0; e < a.selectpicker.main.data.length; e++) {
                  ...
                  h[e] || (h[e] = d(l, g, j, k)),
                    h[e] &&
                      ...
                      (l.headerIndex > 0 && ((h[l.headerIndex - 1] = !0), i.push(l.headerIndex - 1)),
                      (h[l.headerIndex] = !0),
                ...
                for (var e = 0, m = i.length; e < m; e++) {
                  ...
                  ('divider' !== l.type || ('divider' === l.type && q && 'divider' !== q.type && m - 1 !== e)) &&
                    (a.selectpicker.search.data.push(l),
                    f.push(a.selectpicker.main.elements[n]),
                    (a.selectpicker.search.map.newIndex[l.originalIndex] = f.length - 1),
                    (a.selectpicker.search.map.originalIndex[f.length - 1] = l.originalIndex));
                }
                (a.activeIndex = void 0),
                  ...
                  f.length ||
                    ...
                    (b.innerHTML = a.options.noneResultsText.replace('{0}', '"' + p(c) + '"')),
        ...
        keydown: function (b) {
          ...
          if (
            ...
            b.which === s.ESCAPE && e && (b.preventDefault(), k.$button.trigger('click.bs.dropdown.data-api').focus()),
            o)
          ) {
            if (!l.length) return;
              ...
              b.which === s.ARROW_UP
                ? (-1 !== c && c--,
                  ...
                  k.selectpicker.view.canHighlight[c + t] ||
                    (-1 === (c = k.selectpicker.view.canHighlight.slice(0, c + t).lastIndexOf(!0) - t) &&
                      (c = l.length - 1)))
                : (b.which === s.ARROW_DOWN || n) &&
                  (c++,
                  c + t >= k.selectpicker.view.canHighlight.length && (c = 0),
                  k.selectpicker.view.canHighlight[c + t] ||
                    (c = c + 1 + k.selectpicker.view.canHighlight.slice(c + t + 1).indexOf(!0))),
              b.preventDefault();
            var x = t + c;
            b.which === s.ARROW_UP
              ? 0 === t && c === l.length - 1
                ...
                : ((g = k.selectpicker.current.data[x]), (h = g.position - g.height), (m = h < p))
              : (b.which === s.ARROW_DOWN || n) &&
                (0 !== t && 0 === c
                  ? ((k.$menuInner[0].scrollTop = 0), (x = 0))
                  : ((g = k.selectpicker.current.data[x]), (h = g.position - k.sizeInfo.menuInnerHeight), (m = h > p))),
            ...
            if (A.length) {
              ...
              l.removeClass('active').find('a').removeClass('active'),
                ...
                p - g.position > 0
                  ...
                  : ((h = g.position - k.sizeInfo.menuInnerHeight), (m = g.position > p + k.sizeInfo.menuInnerHeight)),
          ...
          e &&
            ...
            (k.options.liveSearch && b.which === s.SPACE) ||
              ...
              i.focus(),
              k.options.liveSearch || (b.preventDefault(), a(document).data('spaceSelect', !0))));
        },
        mobile: function () {
