        ...
        c(this, j),
          ...
          this.$element.on('switchChange.bootstrapSwitch', function () {
            ...
            !1 === l.options.onSwitchChange.apply(k, o) &&
              (l.$element.is(':radio')
                ? g('[name="' + l.$element.attr('name') + '"]').trigger('previousState.bootstrapSwitch', !0)
        ...
        f(j, [
            ...
            value: function (l, m) {
              return 'undefined' == typeof l
                ...
                : (this.$element.is(':radio')
                    ? g('[name="' + this.$element.attr('name') + '"]').trigger('setPreviousOptions.bootstrapSwitch')
          ...
          },
          {
            ...
            value: function (l) {
              return this.options.disabled || this.options.readonly
                ...
                : this.$element.prop('checked', !this.options.state).trigger('change.bootstrapSwitch', l);
            },
          },
          {
            key: 'size',
            value: function (l) {
              return 'undefined' == typeof l
                ? this.options.size
                : (null != this.options.size && this.$wrapper.removeClass(this._getClass(this.options.size)),
          ...
          },
          {
            ...
            value: function (l) {
              return 'undefined' == typeof l
                ...
                : (this.options.onColor && this.$on.removeClass(this._getClass(this.options.onColor)),
          ...
          },
          {
            ...
            value: function (l) {
              return 'undefined' == typeof l
                ...
                : (this.options.offColor && this.$off.removeClass(this._getClass(this.options.offColor)),
          ...
          },
          {
            ...
            value: function (l) {
              return 'undefined' == typeof l
                ...
                : ((this.options.handleWidth = l), this._width(), this._containerPosition(), this.$element);
            },
          },
          {
            key: 'labelWidth',
            value: function (l) {
              return 'undefined' == typeof l
                ...
                : ((this.options.labelWidth = l), this._width(), this._containerPosition(), this.$element);
            },
          },
          {
            key: 'baseClass',
          ...
          },
          {
            ...
            value: function (l) {
              return 'undefined' == typeof l
                ? this.options.onInit
                : (l || (l = g.fn.bootstrapSwitch.defaults.onInit), (this.options.onInit = l), this.$element);
            },
          },
          {
            key: 'onSwitchChange',
              ...
              return this.$element.on({
                ...
                'previousState.bootstrapSwitch': function () {
                  (l.options = l.prevOptions),
                    ...
                    l.$element.prop('checked', l.options.state).trigger('change.bootstrapSwitch', !0);
                },
            ...
            value: function () {
              ...
              return (
                this.$on.on('click.bootstrapSwitch', function (m) {
                  return (
                    m.preventDefault(), m.stopPropagation(), l.state(!1), l.$element.trigger('focus.bootstrapSwitch')
                  );
                }),
                this.$off.on('click.bootstrapSwitch', function (m) {
                  return (
                    m.preventDefault(), m.stopPropagation(), l.state(!0), l.$element.trigger('focus.bootstrapSwitch')
                  );
                })
              );
            },
              ...
              this.$label.on({
                ...
                'mousedown.bootstrapSwitch touchstart.bootstrapSwitch': function (o) {
                  l._dragStart ||
                    ...
                    o.stopPropagation(),
                    (l._dragStart =
                      (o.pageX || o.originalEvent.touches[0].pageX) - parseInt(l.$container.css('margin-left'), 10)),
                ...
                'mouseup.bootstrapSwitch touchend.bootstrapSwitch': function (o) {
                  if (l._dragStart) {
                    if (
                      (o.preventDefault(), l.options.animate && l.$wrapper.addClass(l._getClass('animate')), l._dragEnd)
                    ) {
