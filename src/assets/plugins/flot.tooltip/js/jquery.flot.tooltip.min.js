  ...
  (c.prototype.init = function (b) {
    ...
    b.hooks.bindEvents.push(function (b, f) {
      if (
        ...
        e.plotOptions.tooltip.show !== !1 && 'undefined' != typeof e.plotOptions.tooltip.show)
      ) {
    ...
    (c.prototype.stringFormat = function (a, b) {
      ...
      if (
        ...
        (a = 'undefined' != typeof b.series.color ? a.replace(i, b.series.color) : a.replace(i, '')),
        (a = this.hasAxisLabel('xaxis', b) ? a.replace(j, b.series.xaxis.options.axisLabel) : a.replace(j, '')),
        (a = this.hasAxisLabel('yaxis', b) ? a.replace(k, b.series.yaxis.options.axisLabel) : a.replace(k, '')),
        this.isTimeMode('xaxis', b) &&
          this.isXDateFormat(b) &&
          (a = a.replace(l, this.timestampToDate(c, this.tooltipOptions.xDateFormat, b.series.xaxis.options))),
        this.isTimeMode('yaxis', b) &&
          this.isYDateFormat(b) &&
          (a = a.replace(m, this.timestampToDate(d, this.tooltipOptions.yDateFormat, b.series.yaxis.options))),
      ...
      return (
        'undefined' != typeof b.series.xaxis.tickFormatter &&
          (a = a.replace(n, b.series.xaxis.tickFormatter(c, b.series.xaxis).replace(/\$/g, '$$'))),
        'undefined' != typeof b.series.yaxis.tickFormatter &&
          (a = a.replace(o, b.series.yaxis.tickFormatter(d, b.series.yaxis).replace(/\$/g, '$$'))),
        e && (a = a.replace(p, e)),
        a
      );
    }),
