...
(function () {
    ...
    switch (typeof b) {
      ...
      case 'object':
        ...
        if (j && 'object' === typeof j) {
          p = j.length;
          for (c = 0; c < p; c += 1)
            'string' === typeof j[c] && ((d = j[c]), (h = n(d, b)) && f.push(q(d) + (e ? ': ' : ':') + h));
        } else
          for (d in b)
            Object.prototype.hasOwnProperty.call(b, d) && (h = n(d, b)) && f.push(q(d) + (e ? ': ' : ':') + h);
        h = 0 === f.length ? '{}' : e ? '{\n' + e + f.join(',\n' + e) + '\n' + g + '}' : '{' + f.join(',') + '}';
        e = g;
        return h;
    }
  ...
  'function' !== typeof JSON.stringify &&
    (JSON.stringify = function (a, k, c) {
      var d;
      m = e = '';
      if ('number' === typeof c) for (d = 0; d < c; d += 1) m += ' ';
      else 'string' === typeof c && (m = c);
      if ((j = k) && 'function' !== typeof k && ('object' !== typeof k || 'number' !== typeof k.length))
  ...
  'function' !== typeof JSON.parse &&
    (JSON.parse = function (a, e) {
      ...
      if (
        ...
        return (d = eval('(' + a + ')')), 'function' === typeof e ? c({ '': d }, '') : d;
