            ...
            (n.minLeft = Math.min(0, p)),
              ...
              s &&
                ...
                2 === h &&
                  ...
                  n.height >= a.height && ((n.minTop = Math.min(0, m)), (n.maxTop = Math.max(0, m)))));
          ...
          it(this.previews, function (t) {
            ...
            s && (o = c * (h = e / s)),
              ...
              ot(
                ...
                et({ width: d * h, height: l * h }, kt(et({ translateX: -p * h, translateY: -m * h }, r)))
              );
          }));
      },
    },
    ...
    Xt = {
      ...
      dblclick: function () {
        ...
        this.disabled ||
          ...
          this.setDragMode(
            ((t = this.dragBox), (i = h), (t.classList ? t.classList.contains(i) : -1 < t.className.indexOf(i)) ? c : s)
          );
      },
      wheel: function (t) {
        var i = this,
    ...
    St = {
      ...
      scale: function (t) {
        ...
        return (
          ...
          this.ready &&
            ...
            (K(t) && ((e.scaleX = t), (a = !0)), K(i) && ((e.scaleY = i), (a = !0)), a && this.renderCanvas(!0, !0)),
          this
        );
      },
      getData: function () {
      ...
      getCropBoxData: function () {
        var t = this.cropBoxData,
          i = void 0;
        return (
          this.ready && this.cropped && (i = { left: t.left, top: t.top, width: t.width, height: t.height }), i || {}
        );
      },
              ...
              value: function () {
                if (this.sized && !this.ready) {
                  ...
                  (this.container = a),
                    ...
                    i.cropBoxResizable ||
                      (ht(s.getElementsByClassName(l + '-line'), S), ht(s.getElementsByClassName(l + '-point'), S)),
                    this.render(),
                    (this.ready = !0),
