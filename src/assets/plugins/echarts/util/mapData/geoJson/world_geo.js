  ...
  return {
    ...
    features: [
      ...
      },
      {
        ...
        geometry: { type: 'Polygon', coordinates: ['@@ÐJŨȮ؄Yކʢ֧ΧÔƿęǇÙűj¥iĎÑ¾ǋVɫïƿ¬'], encodeOffsets: [[33518, 35984]] },
      },
      {
        type: 'Feature',
        id: 'CYP',
        properties: { name: 'Cyprus' },
        geometry: { type: 'Polygon', coordinates: ['@@ãࡱͿЩŊȟͶЎǀ«ɬðǌUÒ½jč¦ŲiǈÚĚ'], encodeOffsets: [[34789, 35900]] },
      },
      {
        type: 'Feature',
        id: 'CZE',
      ...
      },
      {
        ...
        geometry: { type: 'Polygon', coordinates: ['@@ȤʹΑӏȩήɯ̱҇ȅƬȭÏҷb_ʮßɶ˴Ѐ̐ϊήñʪȴ'], encodeOffsets: [[44116, 13005]] },
      },
      {
        type: 'Feature',
        id: 'DNK',
      ...
      },
      {
        ...
        geometry: { type: 'Polygon', coordinates: ['@@ńOǤӺżȊ˺¶ϴbтˏÒ։ǅƑƥҕh͋ǿջõΑȴšήń˸'], encodeOffsets: [[21085, 42860]] },
      },
      {
        type: 'Feature',
        id: 'MLI',
      ...
      },
      {
        ...
        geometry: { type: 'Polygon', coordinates: ['@@ڱǳȇ̎ɡՔãкȆݴɁ̬ăڎD؎ΕѠÖˀ݂kŅѵʲʝ̈̋ЭǜǥኝȺׅ'], encodeOffsets: [[1911, 6290]] },
      },
      {
        type: 'Feature',
        id: 'THA',
