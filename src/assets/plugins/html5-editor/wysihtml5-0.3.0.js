...
rangy.createModule('DomRange', function (api, module) {
  ...
  RangePrototype.prototype = {
    ...
    isPointInRange: function (node, offset) {
      ...
      return (
        dom.comparePoints(node, offset, this.startContainer, this.startOffset) >= 0 &&
...
rangy.createModule('WrappedSelection', function (api, module) {
  ...
  var selectionHasAnchorAndFocus = util.areHostObjects(
    testSelection,
    ['anchorNode', 'focusNode'] && util.areHostProperties(testSelection, ['anchorOffset', 'focusOffset'])
  );
    ...
    /** @scope wysihtml5.Editor.prototype */ {
      constructor: function (textareaElement, config) {
        this.textareaElement =
          typeof textareaElement === 'string' ? document.getElementById(textareaElement) : textareaElement;
