  ...
  var tpl = {
    'font-styles': function (locale, options) {
      ...
      return (
        ...
        "<li class='dropdown-item'><a class='dropdown-link' data-wysihtml5-command='formatBlock' data-wysihtml5-command-value='div'>" +
        locale.font_styles.normal +
        '</a></li>' +
        "<li class='dropdown-item'><a class='dropdown-link' data-wysihtml5-command='formatBlock' data-wysihtml5-command-value='h1'>" +
        locale.font_styles.h1 +
        '</a></li>' +
        "<li class='dropdown-item'><a class='dropdown-link' data-wysihtml5-command='formatBlock' data-wysihtml5-command-value='h2'>" +
        locale.font_styles.h2 +
        '</a></li>' +
        "<li class='dropdown-item'><a class='dropdown-link' data-wysihtml5-command='formatBlock' data-wysihtml5-command-value='h3'>" +
