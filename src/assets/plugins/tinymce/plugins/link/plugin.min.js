  ...
  var t = tinymce.util.Tools.resolve('tinymce.PluginManager'),
    ...
    L = function (i, r) {
      return function (o) {
        i.undoManager.transact(function () {
          ...
          C(i.settings) || !1 !== N(i.settings) || (n.rel = s(n.rel, '_blank' === n.target)),
            o.href === r.href && (r.attach(), (r = {})),
            e
              ? (i.focus(),
                o.hasOwnProperty('text') && ('innerText' in e ? (e.innerText = o.text) : (e.textContent = o.text)),
    ...
    V = function (a, t) {
      var e,
        ...
        h = function (t) {
          var e = o.find('#text');
          (!e.value() || (t.lastControl && e.value() === t.lastControl.text())) && e.value(t.control.text()),
      ...
      (u = E(v.getContent())),
        ...
        w(a.settings) &&
          ...
          (c = { name: 'target', type: 'listbox', label: 'Target', values: F(b(a.settings)) })),
        C(a.settings) &&
          (r = {
            name: 'rel',
            type: 'listbox',
    ...
    et = function (t) {
      t.addButton('link', { active: !1, icon: 'link', tooltip: 'Insert/edit link', onclick: j(t), onpostrender: W(t) }),
        t.addButton('unlink', {
          active: !1,
          icon: 'unlink',
          tooltip: 'Remove link',
