!(function () {
  ...
  var e = tinymce.util.Tools.resolve('tinymce.PluginManager'),
          ...
          : ((i = e),
            ...
            p({
              ...
              start: function (e, t) {
                ...
                'source' === e && (a.source1 ? a.source2 || (a.source2 = t.map.src) : (a.source1 = t.map.src)),
                  ...
                  if (o)
                    switch (e) {
                      ...
                      case 'source':
                        if (
                          ++s <= 2 &&
                          (F(t, { src: a['source' + s], type: a['source' + s + 'mime'] }), !a['source' + s])
                        )
                          return;
                        break;
                      case 'img':
                  ...
                  if ('video' === e && o)
                    for (var t = 1; t <= 2; t++)
                      if (a['source' + t]) {
                        ...
                        (r.map = {}),
                          s < t &&
                            (F(r, { src: a['source' + t], type: a['source' + t + 'mime'] }), c.start('source', r, !0));
                      }
      ...
      return (
        ...
        'iframe' === i.type
          ? ((p = (h = i).allowFullscreen ? ' allowFullscreen="1"' : ''),
            '<iframe src="' + h.source1 + '" width="' + h.width + '" height="' + h.height + '"' + p + '></iframe>')
          ...
          ? ((d =
            ...
            m.poster && (d += '<img src="' + m.poster + '" width="' + m.width + '" height="' + m.height + '" />'),
            (d += '</object>'))
    ...
    B = function (i) {
      ...
      if (
        (m(i) &&
          c.push({ name: 'source2', type: 'filepicker', filetype: 'media', size: 40, label: 'Alternative source' }),
        d(i) && c.push({ name: 'poster', type: 'filepicker', filetype: 'image', size: 40, label: 'Poster' }),
        h(i))
      ) {
        var s = J(function (e) {
      ...
      (r = (e = i).selection.getNode()),
        ...
        (t = o
          ? { source1: o, 'data-ephox-embed-iri': o, width: f.getMaxWidth(r), height: f.getMaxHeight(r) }
          ...
          (t = e[i]).parent &&
            (t.parent.attr('data-mce-object') ||
              (('script' !== t.name || (r = x(w(a), t.attr('src')))) &&
                (r &&
                  (r.width && t.attr('width', r.width.toString()), r.height && t.attr('height', r.height.toString())),
                'iframe' === t.name && n(a) && o.ceFalse ? ee(t) || t.replace(Y(a, t)) : ee(t) || t.replace(X(a, t)))));
      };
    },
    re = function (d) {
      d.on('preInit', function () {
        ...
        v.each('webkitallowfullscreen mozallowfullscreen allowfullscreen'.split(' '), function (e) {
          ...
          d.parser.addNodeFilter('iframe,video,audio,object,embed,script', te(d)),
              ...
              if ((r = e[l]).parent) {
                  ...
                  s = r.attr(t),
                    ...
                    'audio' !== s &&
                      ...
                      ((u = r.attr('class')) && -1 !== u.indexOf('mce-preview-object')
                        ? i.attr({ width: r.firstChild.attr('width'), height: r.firstChild.attr('height') })
                        : i.attr({ width: r.attr('width'), height: r.attr('height') })),
                ...
                'script' === s && i.attr('type', 'text/javascript'),
                  (n = r.attr('data-mce-html')) &&
                    (((c = new K('#text', 3)).raw = !0), (c.value = Q(d, unescape(n))), i.append(c)),
                  r.replace(i);
              }
          });
      }),
      ...
      t.on('click keyup', function () {
        ...
        t.on('objectResized', function (e) {
          ...
          r.getAttribute('data-mce-object') &&
            ...
            ((t = unescape(t)), r.setAttribute('data-mce-html', escape(A(t, { width: e.width, height: e.height }))));
        });
    },
    oe = function (e) {
      e.addButton('media', {
