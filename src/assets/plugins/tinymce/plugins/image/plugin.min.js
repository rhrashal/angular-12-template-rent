!(function () {
  ...
  var e = tinymce.util.Tools.resolve('tinymce.PluginManager'),
    ...
    r = function (e, t) {
      for (var n = t !== undefined && null !== t ? t : a, r = 0; r < e.length && n !== undefined && null !== n; ++r)
        n = n[e[r]];
      return n;
    },
    i = function (e, t) {
  ...
  var n = tinymce.util.Tools.resolve('tinymce.util.Promise'),
    ...
    g = {
      getImageSize: function (e, n) {
        var r = document.createElement('img');
        function t(e, t) {
          r.parentNode && r.parentNode.removeChild(r), n({ width: e, height: t });
        }
        (r.onload = function () {
          t(u(r.width, r.clientWidth), u(r.height, r.clientHeight));
        }),
          (r.onerror = function () {
            t(0, 0);
          });
    ...
    p = function (o) {
      return function () {
        ...
        for (var n = {}, r = 0; r < e.length; r++) {
          var a = e[r];
          for (var i in a) a.hasOwnProperty(i) && (n[i] = o(n[i], a[i]));
        }
        return n;
      };
    },
    h = p(function (e, t) {
      return m.isObject(e) && m.isObject(t) ? h(e, t) : t;
    }),
    v = p(function (e, t) {
      return t;
    }),
    b = { deepMerge: h, merge: v },
    y = s.DOM,
    x = function (e) {
      return e.style.marginLeft && e.style.marginRight && e.style.marginLeft === e.style.marginRight
        ? g.removePixelSuffix(e.style.marginLeft)
        : '';
    },
    w = function (e) {
      return e.style.marginTop && e.style.marginBottom && e.style.marginTop === e.style.marginBottom
        ? g.removePixelSuffix(e.style.marginTop)
        : '';
    },
    S = function (e) {
      return e.style.borderWidth ? g.removePixelSuffix(e.style.borderWidth) : '';
    },
    U = function (e, t) {
    ...
    I = function (e) {
      var t, n, r, a;
      T(e)
        ? ((a = (r = e).parentNode), y.insertAfter(r, a), y.remove(a))
        : ((t = e),
          (n = y.create('figure', { class: 'image' })),
          y.insertAfter(n, t),
          n.appendChild(t),
          n.appendChild(y.create('figcaption', { contentEditable: !0 }, 'Caption')),
    ...
    A = function (e, r) {
      return function (e, t, n) {
        e.style[t] ? ((e.style[t] = g.addPixelSuffix(n)), N(e, r)) : P(e, t, n);
      };
    },
    L = function (e, t) {
      return e.style[t] ? g.removePixelSuffix(e.style[t]) : U(e, t);
    },
    _ = function (e, t) {
      var n = g.addPixelSuffix(t);
    ...
    z = function (e, t) {
      ...
      return (
        P(n, 'style', t.style),
        (x(n) || '' !== t.hspace) && _(n, t.hspace),
        (w(n) || '' !== t.vspace) && O(n, t.vspace),
        (S(n) || '' !== t.border) && R(n, t.border),
        (C(n, 'borderStyle') || '' !== t.borderStyle) && D(n, t.borderStyle),
    ...
    j = function (e, t, n) {
      var r = M(e, n);
      E(n, r, t, 'caption', function (e, t, n) {
        return I(e);
      }),
        E(n, r, t, 'src', P),
        E(n, r, t, 'alt', P),
        ...
        E(n, r, t, 'hspace', H(_, e)),
        E(n, r, t, 'vspace', H(O, e)),
        E(n, r, t, 'border', H(R, e)),
        E(n, r, t, 'borderStyle', H(D, e));
    },
    B = function (e, t) {
    ...
    F = function (e) {
      ...
      return n
        ...
        : t && ('IMG' !== t.nodeName || t.getAttribute('data-mce-object') || t.getAttribute('data-mce-placeholder'))
        ? null
        : t;
    },
    W = function (t, e) {
    ...
    J = function (t, e) {
      var n = (function (e, t) {
        var n = document.createElement('img');
        if ((j(e, b.merge(t, { caption: !1 }), n), P(n, 'alt', t.alt), t.caption)) {
          var r = y.create('figure', { class: 'image' });
          return (
            r.appendChild(n),
            r.appendChild(y.create('figcaption', { contentEditable: !0 }, 'Caption')),
        ...
        ? t.src
          ? (function (t, e) {
              ...
              if (
                ...
                var a = r.parentNode;
                W(t, a), t.selection.select(r.parentNode);
              } else t.selection.select(r), g.waitLoadImage(t, e, r);
            })(e, t)
          : (function (e, t) {
              if (t) {
              ...
              onchange:
                ...
                function (e) {
                  ...
                  if (d.hasAdvTab(i)) {
                    ...
                    n.find('#vspace').value(''),
                      n.find('#hspace').value(''),
                      (((a = g.mergeMargins(a))['margin-top'] && a['margin-bottom']) ||
                        (a['margin-right'] && a['margin-left'])) &&
                        (a['margin-top'] === a['margin-bottom']
                          ? n.find('#vspace').value(g.removePixelSuffix(a['margin-top']))
                          : n.find('#vspace').value(''),
                        a['margin-right'] === a['margin-left']
                          ? n.find('#hspace').value(g.removePixelSuffix(a['margin-right']))
                          : n.find('#hspace').value('')),
                      a['border-width']
                        ? n.find('#border').value(g.removePixelSuffix(a['border-width']))
                        : n.find('#border').value(''),
                      a['border-style']
    ...
    Q = function (e, t, n) {
      ...
      n &&
        ...
        o &&
        (i !== r
          ? ((o = Math.round((i / r) * o)), isNaN(o) || t.value(o))
          : ((i = Math.round((o / a) * i)), isNaN(i) || e.value(i))),
        q(e, t);
    },
    Y = function (e) {
      K(e, Q);
    ...
    Z = {
      createUi: function () {
        ...
        return {
          ...
          spacing: 5,
          items: [
            { name: 'width', type: 'textbox', maxLength: 5, size: 5, onchange: e, ariaLabel: 'Width' },
            { type: 'label', text: 'x' },
            { name: 'height', type: 'textbox', maxLength: 5, size: 5, onchange: e, ariaLabel: 'Height' },
    ...
    te = function (c, e) {
      var t = [
        {
          ...
          onchange: function (e) {
            ...
            (n = c),
              ...
              (l = t.control),
              (u = l.rootControl),
              (s = u.find('#image-list')[0]) && s.value(n.convertURL(l.value(), 'src')),
              ...
              o.width ||
                ...
                (a = d.getPrependUrl(n)),
                (i = new RegExp('^(?:[a-z]+:)?//', 'i')),
                a && !i.test(r) && r.substring(0, a.length) !== a && (r = a + r),
                l.value(r),
                g.getImageSize(n.documentBaseURI.toAbsolute(l.value()), function (e) {
                  e.width &&
                    e.height &&
                    d.hasDimensions(n) &&
                    (u.find('#width').value(e.width), u.find('#height').value(e.height), Z.syncSize(u));
                }));
          },
          onbeforecall: ee,
        },
      ...
      return (
        d.hasDescription(c) && t.push({ name: 'alt', type: 'textbox', label: 'Image description' }),
        d.hasImageTitle(c) && t.push({ name: 'title', type: 'textbox', label: 'Image Title' }),
        d.hasDimensions(c) && t.push(Z.createUi()),
        d.getClassList(c) &&
          t.push({
            name: 'class',
            type: 'listbox',
            label: 'Class',
            values: g.buildListItems(d.getClassList(c), function (e) {
              e.value &&
                (e.textStyle = function () {
                  return c.formatter.getCssText({ inline: 'img', classes: [e.value] });
                });
            }),
          }),
        d.hasImageCaption(c) && t.push({ name: 'caption', type: 'checkbox', label: 'Caption' }),
        t
      );
    },
    ne = {
      makeTab: function (e, t) {
        return { title: 'General', type: 'form', items: te(e, t) };
      },
      getGeneralItems: te,
    },
    re = function () {
    ...
    oe = tinymce.util.Tools.resolve('tinymce.ui.Factory');
  function le() {
  ...
  function ce(o) {
    var t = function (e, t, n, r) {
      var a, i;
      (a = new le()).open('POST', o.url),
        (a.withCredentials = o.credentials),
        (a.upload.onprogress = function (e) {
          r((e.loaded / e.total) * 100);
        }),
        (a.onerror = function () {
          n('Image upload failed due to a XHR Transport error. Code: ' + a.status);
        }),
        (a.onload = function () {
          var e;
          a.status < 200 || 300 <= a.status
            ? n('HTTP Error: ' + a.status)
            : (e = JSON.parse(a.responseText)) && 'string' == typeof e.location
            ? t(se(o.basePath, e.location))
            : n('Invalid JSON: ' + a.responseText);
        }),
        (i = new FormData()).append('file', e.blob(), e.filename()),
        a.send(i);
    };
    return (
      (o = f.extend({ credentials: !1, handler: t }, o)),
      {
        upload: function (e) {
  ...
  var de = function (u) {
      return function (e) {
        var t = oe.get('Throbber'),
          n = e.control.rootControl,
          r = new t(n.getEl()),
          a = e.control.value(),
          i = ae(a),
          o = ce({
            url: d.getUploadUrl(u),
            basePath: d.getUploadBasePath(u),
            credentials: d.getUploadCredentials(u),
            handler: d.getUploadHandler(u),
          }),
          l = function () {
            r.hide(), ie(i);
          };
        return (
          ...
          g
            ...
            .then(function (e) {
              ...
              return o.upload(t).then(function (e) {
                var t = n.find('#src');
          ...
          items: [
            {
              ...
              spacing: 10,
              items: [
                { text: 'Browse for an image', type: 'browsebutton', accept: fe, onchange: de(e) },
                { text: 'OR', type: 'label' },
              ],
            },
            { text: 'Drop an image here', type: 'dropzone', accept: fe, height: 100, onchange: de(e) },
          ],
        };
      },
    },
  ...
  function ve(i) {
    function e(e) {
      ...
      if (
        (e &&
          (t = {
            ...
            values: g.buildListItems(
              e,
              function (e) {
                e.value = i.convertURL(e.value || e.url, 'src');
              },
              [{ text: 'None', value: '' }]
            ),
            value: r.src && i.convertURL(r.src, 'src'),
            onselect: function (e) {
              var t = n.find('#alt');
        ...
        d.hasAdvTab(i) || d.hasUploadUrl(i) || d.hasUploadHandler(i))
      ) {
        var a = [ne.makeTab(i, t)];
        d.hasAdvTab(i) && a.push(X.makeTab(i)),
          (d.hasUploadUrl(i) || d.hasUploadHandler(i)) && a.push(ge.makeTab(i)),
          (n = i.windowManager.open({
            title: 'Insert/edit image',
            data: r,
            bodyType: 'tabpanel',
            body: a,
            onSubmit: pe.curry(he, i),
          }));
      } else
        n = i.windowManager.open({
          title: 'Insert/edit image',
          data: r,
          body: ne.getGeneralItems(i, t),
          onSubmit: pe.curry(he, i),
        });
      Z.syncSize(n);
    }
    return {
      open: function () {
        g.createImageList(i, e);
      },
    };
  }
  var be = function (e) {
      e.addCommand('mceImage', ve(e).open);
    },
    ye = function (i) {
      return function (e) {
        for (
          ...
          (t = e[r]),
            (n = t.attr('class')) &&
              /\bimage\b/.test(n) &&
              (t.attr('contenteditable', i ? 'false' : null), f.each(t.getAll('figcaption'), a));
      };
    },
    xe = function (e) {
      e.on('preInit', function () {
        e.parser.addNodeFilter('figure', ye(!0)), e.serializer.addNodeFilter('figure', ye(!1));
      });
    },
    we = function (e) {
      e.addButton('image', {
