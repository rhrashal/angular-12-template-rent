  ...
  var e = tinymce.util.Tools.resolve('tinymce.PluginManager'),
            ...
            1 === n.nodeType &&
              ...
              n.hasChildNodes()
                ? ((o = Math.min(o, n.childNodes.length - 1)),
                  e ? n.insertBefore(t, n.childNodes[o]) : S.insertAfter(t, n.childNodes[o]))
                : n.appendChild(t),
              (n = t),
              (o = 0)),
        ...
        (t = o = r[e ? 'startContainer' : 'endContainer']),
          ...
          t &&
            (1 === t.nodeType &&
              ...
              (t = t.parentNode),
              S.remove(o),
              !t.hasChildNodes() && S.isBlock(t) && t.appendChild(S.create('br'))),
    ...
    T = function (e, t) {
      ...
      'LI' === o.nodeName &&
        ...
        h(o) && (n = o.previousSibling) && 'LI' === n.nodeName && n.appendChild(t);
    },
    I = function (t, e) {
    ...
    x = function (e, t, n) {
      ...
      if (
        ...
        for (; (o = t.firstChild); ) {
          var d = o.nodeName;
          i || ('SPAN' === d && 'bookmark' === o.getAttribute('data-mce-type')) || (i = !0),
            f(o, s)
      ...
      return (
        e.settings.forced_root_block
          ? i || (A.ie && !(10 < A.ie)) || r.appendChild(P.create('br', { 'data-mce-bogus': '1' }))
          ...
          ? ((n = r.parentNode),
            r === e.getBody() ||
              ('DD' === t.nodeName
                ...
                : ('LI' === n.nodeName ? ((r = n), (o = x(e, t, 'LI'))) : (o = h(n) ? x(e, t, 'LI') : x(e, t)),
                  M(e, r, t, o),
    ...
    j = function (e, t, n, o) {
      ...
      for (
        r = t[n ? 'startContainer' : 'endContainer'],
          ...
          1 === r.nodeType && (r = r.childNodes[Math.min(i, r.childNodes.length - 1)] || r),
    ...
    q = function (c, f, u) {
      ...
      'false' !== g.getContentEditable(c.selection.getNode()) &&
        ...
        v.each(
          (function (n, e, o) {
            for (
              var r, i = [], a = n.dom, t = j(n, e, !0, o), s = j(n, e, !1, o), d = [], l = t;
              l && (d.push(l), l !== s);
              l = l.nextSibling
            );
            return (
              v.each(d, function (e) {
                ...
                p.isBookmarkNode(e) && (y(n, t) || (!t && e.parentNode === o))
                  ? (r = null)
                  : (r || ((r = a.create('p')), e.parentNode.insertBefore(r, e), i.push(r)), r.appendChild(e));
              }),
              i
            );
          })(c, t, n),
          function (e) {
            ...
            i === (a = null === a ? '' : a))
              ...
              : ((t = g.create(f)), e.parentNode.insertBefore(t, e), t.appendChild(e), (e = g.rename(e, m))),
              (s = g),
              (d = e),
              (l = [
                'margin',
    ...
    V = function (e, t, n) {
      return (
        ...
        (s = t) &&
          ...
          ((i = t), (a = n), (r = e).getStyle(i, 'list-style-type', !0) === r.getStyle(a, 'list-style-type', !0)) &&
    ...
    te = function (e, t, n) {
      ...
      g(e, t) &&
        ...
        i === n.lastChild && C(i.previousSibling) && e.remove(i.previousSibling),
    ...
    oe = function (e, t) {
      ...
      if (l) {
        ...
        if (((o = L(a.getRng(!0))), (r = i.getParent(Y(e, o, t, d), 'LI', d)) && r !== l))
          return (
            t
              ? ne(e, o, r, l)
              : (function (e, t, n, o) {
    ...
    ie = function (e, t) {
      return e.selection.isCollapsed()
        ...
        : ((o = (n = e).selection.getStart()),
          ...
          !!(n.dom.getParent(o, 'LI,DT,DD', r) || 0 < E.getSelectedListItems(n).length) &&
        ...
        for (
          ...
          ('DT' === t.nodeName
            ...
            : (n = t.previousSibling) &&
              ...
              (r = le.getStyle(t.parentNode, 'listStyleType')) && le.setStyle(o, 'listStyleType', r),
              n.appendChild(o),
              o.appendChild(t),
              ce(t.lastChild, o),
              1)) || 0 !== s);
    ...
    me = function (o) {
      o.on('BeforeExecCommand', function (e) {
        ...
        if (('indent' === n ? fe(o) && (t = !0) : 'outdent' === n && K(o) && (t = !0), t))
          return o.fire('ExecCommand', { command: e.command }), e.preventDefault(), !0;
      }),
    ...
    pe = function (e) {
      ...
      ge(e) &&
        (t = e).on('keydown', function (e) {
          e.keyCode !== n.TAB ||
            n.metaKeyPressed(e) ||
            (t.dom.getParent(t.selection.getStart(), 'LI,DT,DD') && (e.preventDefault(), e.shiftKey ? K(t) : fe(t)));
        }),
        ae(e);
    },
    ve = function (t, i) {
