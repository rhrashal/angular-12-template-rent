!(function () {
  ...
  var e,
    ...
    w = (Array.prototype.push, Array.prototype.slice, h.isFunction(Array.from) && Array.from, v),
    A = b,
    C = function (e, t) {
    ...
    O = T.mac ? '\u2318' : 'Ctrl',
    _ = T.mac ? 'Ctrl + Alt' : 'Shift + Alt',
    F = {
      shortcuts: [
        { shortcut: O + ' + B', action: 'Bold' },
        { shortcut: O + ' + I', action: 'Italic' },
        { shortcut: O + ' + U', action: 'Underline' },
        { shortcut: O + ' + A', action: 'Select all' },
        { shortcut: O + ' + Y or ' + O + ' + Shift + Z', action: 'Redo' },
        { shortcut: O + ' + Z', action: 'Undo' },
        { shortcut: _ + ' + 1', action: 'Header 1' },
        { shortcut: _ + ' + 2', action: 'Header 2' },
        { shortcut: _ + ' + 3', action: 'Header 3' },
        { shortcut: _ + ' + 4', action: 'Header 4' },
        { shortcut: _ + ' + 5', action: 'Header 5' },
        { shortcut: _ + ' + 6', action: 'Header 6' },
        { shortcut: _ + ' + 7', action: 'Paragraph' },
        { shortcut: _ + ' + 8', action: 'Div' },
        { shortcut: _ + ' + 9', action: 'Address' },
        ...
        { shortcut: O + ' + K', action: 'Insert link (if link plugin activated)' },
        { shortcut: O + ' + S', action: 'Save (if save plugin activated)' },
        { shortcut: O + ' + F', action: 'Find (if searchreplace plugin activated)' },
      ],
    },
    H = function () {
      var e = w(F.shortcuts, function (e) {
        return (
    ...
    D = function (r) {
      var e,
        ...
        n =
          ((e = r),
          (t = L.keys(e.plugins)),
          e.settings.forced_plugins === undefined ? t : A(t, c.not(c.curry(S, e.settings.forced_plugins)))),
        o = w(n, function (e) {
          return (
            '<li>' +
            ((t = r),
            ...
            C(N, function (e) {
              ...
              function () {
                ...
                return 'function' == typeof e ? z(e()) : n;
              },
              function (e) {
                return z({ name: e.name, url: 'https://www.tinymce.com/docs/plugins/' + e.key });
              }
            )) +
            '</li>'
          );
        ...
        a = o.length,
        i = o.join('');
      return '<p><b>' + P.translate(['Plugins installed ({0}):', a]) + '</b></p><ul>' + i + '</ul>';
    },
    q = function (e) {
      return {
        title: 'Plugins',
    ...
    R = tinymce.util.Tools.resolve('tinymce.EditorManager'),
    U = function () {
      var e,
        t,
        n =
          ...
          ((e = R.majorVersion), (t = R.minorVersion), 0 === e.indexOf('@') ? 'X.X.X' : e + '.' + t) +
          '</a>';
      return [
        { type: 'label', html: P.translate(['You are using {0}', n]) },
        { type: 'spacer', flex: 1 },
        {
          text: 'Close',
          onclick: function () {
    ...
    X = function (e, t) {
      e.addCommand('mceHelp', V(e, t));
    },
    $ = function (e, t) {
      e.addButton('help', { icon: 'help', onclick: V(e, t) }),
        e.addMenuItem('help', { text: 'Help', icon: 'help', context: 'help', onclick: V(e, t) });
    };
  i.add('help', function (e, t) {
    $(e, t), X(e, t), e.shortcuts.add('Alt+0', 'Open help dialog', 'mceHelp');
  });
})();
