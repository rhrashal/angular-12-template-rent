!(function () {
  ...
  var n = tinymce.util.Tools.resolve('tinymce.PluginManager'),
    ...
    u = function (n) {
      n.addButton('save', { icon: 'save', text: 'Save', cmd: 'mceSave', disabled: !0, onPostRender: s(n) }),
        n.addButton('cancel', { text: 'Cancel', icon: !1, cmd: 'mceCancel', disabled: !0, onPostRender: s(n) }),
