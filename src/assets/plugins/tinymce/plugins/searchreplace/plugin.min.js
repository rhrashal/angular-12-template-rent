  ...
  var u = {
                ...
                (function (e) {
                  ...
                  return function (e) {
                    ...
                    if (a === i) {
                      ...
                      (r = d.parentNode),
                        0 < e.startNodeIndex &&
                          ((t = v.createTextNode(d.data.substring(0, e.startNodeIndex))), r.insertBefore(t, d));
                      var c = m(e.match[0], o);
                      return (
                        r.insertBefore(c, d),
                        e.endNodeIndex < d.length &&
                          ((n = v.createTextNode(d.data.substring(e.endNodeIndex))), r.insertBefore(n, d)),
                        d.parentNode.removeChild(d),
                        c
                      );
                    }
                    (t = v.createTextNode(a.data.substring(0, e.startNodeIndex))),
                      (n = v.createTextNode(i.data.substring(e.endNodeIndex)));
                    for (
                      var l = m(a.data.substring(e.startNodeIndex), o), s = [], u = 0, f = e.innerNodes.length;
                      u < f;
                      ++u
                    ) {
    ...
    y = function (e, t, n) {
      ...
      for (a = p.toArray(e.getBody().getElementsByTagName('span')), r = 0; r < a.length; r++) {
        ...
        null !== d &&
          d.length &&
          (d === t.get().toString() && (i || (i = a[r].firstChild), (o = a[r].firstChild)), m(a[r]));
      }
      if (i && o) {
    ...
    T = {
      ...
      replace: function (e, t, n, r, a) {
        var i,
          ...
          u = t.get();
        for (
          r = !1 !== r, d = e.getBody(), o = p.grep(p.toArray(d.getElementsByTagName('span')), N), i = 0;
          i < o.length;
          i++
        ) {
          var f = g(o[i]);
