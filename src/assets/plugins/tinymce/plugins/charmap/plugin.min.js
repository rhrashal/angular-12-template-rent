!(function () {
  ...
  var e = tinymce.util.Tools.resolve('tinymce.PluginManager'),
      ...
      var o,
        e = {
          ...
          onmouseover: function (e) {
            var t = d(e.target);
            t && t.firstChild
              ? (o.find('#preview').text(t.firstChild.firstChild.data), o.find('#previewTitle').text(t.title))
    ...
    p = function (e) {
      e.addButton('charmap', { icon: 'charmap', tooltip: 'Special character', cmd: 'mceShowCharmap' }),
