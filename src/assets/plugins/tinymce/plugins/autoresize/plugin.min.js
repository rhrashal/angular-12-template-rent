  ...
  var i = function (t) {
    ...
    _ = function (t, e) {
      var n,
        ...
        d = t.dom;
      if ((i = t.getDoc()))
        if ((m = t).plugins.fullscreen && m.plugins.fullscreen.isFullscreen()) S(t, !0);
        else {
          var m;
          (o = i.body),
            (r = h(t)),
            ...
            (a =
              ...
              parseInt(c, 10) +
              parseInt(f, 10)),
            (isNaN(a) || a <= 0) && (a = y.ie ? o.scrollHeight : y.webkit && 0 === o.clientHeight ? 0 : o.offsetHeight),
            a > h(t) && (r = a);
          var p = v(t);
    ...
    s = {
      setup: function (i, e) {
        i.on('init', function () {
          ...
          (t = o(i)),
            (e = a(i)),
            !1 !== t && n.setStyles(i.getBody(), { paddingLeft: t, paddingRight: t }),
