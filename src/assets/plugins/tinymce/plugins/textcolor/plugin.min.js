    ...
    P = function (t, e, o, r) {
      ...
      for (
        (n = g(o)).push({ text: h.translate('No color'), color: 'transparent' }),
          l = '<table class="mce-grid mce-grid-border mce-colorbutton-grid" role="list" cellspacing="0"><tbody>',
          c = n.length - 1,
          u = 0;
        u < e;
        u++
    ...
    T = function (r, c) {
      return function (t) {
        var e,
          ...
          l = function (t) {
            a.hidePanel(), a.color(t), r.execCommand('mceApplyTextcolor', a.settings.format, t);
          };
        F.DOM.getParent(t.target, '.mce-custom-color-btn') &&
          ...
          (e = t.target.getAttribute('data-mce-color'))
            ? (this.lastId && F.DOM.get(this.lastId).setAttribute('aria-selected', 'false'),
              ...
              'transparent' === e
                ? (a.hidePanel(), a.resetColor(), r.execCommand('mceRemoveTextcolor', a.settings.format))
                : l(e))
            : null !== e && a.hidePanel();
      };
    },
