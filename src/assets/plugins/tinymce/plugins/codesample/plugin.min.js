!(function () {
              ...
              for (var n in e)
                e.hasOwnProperty(n) &&
                  ...
                  'Object' === S.util.type(e[n])
                    ...
                    : 'Array' === S.util.type(e[n]) && S.languages.DFS(e[n], t, n));
            },
          },
          plugins: {},
          ...
          highlightElement: function (e, t, a) {
            ...
            r && ((n = (r.className.match(c) || [, ''])[1]), (i = S.languages[n])),
              ...
              /pre/i.test(r.nodeName) &&
                (r.className = r.className.replace(c, '').replace(/\s+/g, ' ') + ' language-' + n);
            var s = e.textContent,
  ...
  'undefined' != typeof module && module.exports && (module.exports = r),
    'undefined' != typeof global && (global.Prism = r),
    (r.languages.markup = {
      comment: /<!--[\w\W]*?-->/,
      prolog: /<\?[\w\W]+?\?>/,
      doctype: /<!DOCTYPE[\w\W]+?>/,
    ...
    r.languages.markup &&
      (r.languages.insertBefore('markup', 'tag', {
        style: {
          ...
          inside: {
            tag: { pattern: /<style[\w\W]*?>|<\/style>/i, inside: r.languages.markup.tag.inside },
    ...
    r.languages.markup &&
      r.languages.insertBefore('markup', 'tag', {
        script: {
          ...
          inside: {
            tag: { pattern: /<script[\w\W]*?>|<\/script>/i, inside: r.languages.markup.tag.inside },
            rest: r.languages.javascript,
          },
    ...
    delete r.languages.c['class-name'],
    ...
    r.languages.insertBefore('csharp', 'keyword', { preprocessor: { pattern: /(^\s*)#.*/m, lookbehind: !0 } }),
    ...
    r.languages.insertBefore('cpp', 'keyword', { 'class-name': { pattern: /(class\s+)[a-z0-9_]+/i, lookbehind: !0 } }),
    ...
    r.languages.insertBefore('php', 'operator', { property: { pattern: /(->)[\w]+/, lookbehind: !0 } }),
    r.languages.markup &&
        ...
        if ('php' === e.language) {
          for (var t = 0, a = void 0; (a = e.tokenStack[t]); t++)
            e.highlightedCode = e.highlightedCode.replace(
              '{{{PHP' + (t + 1) + '}}}',
              r.highlight(a, e.grammar, 'php').replace(/\$/g, '$$$$')
            );
      ...
      r.languages.insertBefore('php', 'comment', {
        markup: { pattern: /<[^?]\/?(.*?)>/, inside: r.languages.markup },
        php: /\{\{\{PHP[0-9]+\}\}\}/,
      })),
    (r.languages.python = {
  ...
  var c = {
    ...
    g = function (e) {
      ...
      return c.isCodeSample(t) ? t : null;
    },
    d = g,
    p = function (t, a, n) {
        ...
        (n = i.DOM.encode(n)),
          e
            ? (t.dom.setAttrib(e, 'class', 'language-' + a),
              (e.innerHTML = n),
              r.highlightElement(e),
              t.selection.select(e))
            : (t.insertContent('<pre id="__new" class="language-' + a + '">' + n + '</pre>'),
    ...
    b = function (t) {
      ...
      t.windowManager.open({
        ...
        onSubmit: function (e) {
          p(t, e.data.language, e.data.code);
        },
      });
    },
    y = function (t) {
      t.addCommand('codesample', function () {
        ...
        t.selection.isCollapsed() || c.isCodeSample(e) ? b(t) : t.formatter.toggle('code');
      });
    },
    v = function (a) {
      var i = a.$;
      a.on('PreProcess', function (e) {
        i('pre[contenteditable=false]', e.node)
          .filter(c.trimArg(c.isCodeSample))
          .each(function (e, t) {
            var a = i(t),
              n = t.textContent;
    ...
    k = function (e, t, a, n) {
      ...
      (e.inline && a.get()) ||
        ...
        !1 !== r &&
          ((i = e.dom.create('link', { rel: 'stylesheet', href: r || t + '/css/prism.css' })),
          e.getDoc().getElementsByTagName('head')[0].appendChild(i)));
    },
    w = function (e) {
      e.addButton('codesample', { cmd: 'codesample', title: 'Insert/Edit code sample' }),
