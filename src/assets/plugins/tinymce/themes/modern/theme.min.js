!(function () {
  ...
  var e,
    ...
    I = function (e, t, n, i, r, o) {
      return (
        ...
        e && (o = e({ elementRect: z(i), contentAreaRect: z(r), panelRect: o })),
        o
      );
    },
    F = function (x) {
      var i,
        ...
        n = function (e, t) {
          ...
          if (!x.removed) {
            ...
            (l = ['bc-tc', 'tc-bc', 'tl-bl', 'bl-tl', 'tr-br', 'br-tr']),
              ...
              t && s.show(),
              (d = e.element),
              (f = O.getPos(x.getContentAreaContainer())),
              (h = x.dom.getRect(d)),
              ...
              (r = h),
              (i = O.getRect(s.getEl())),
              (o = O.getRect(x.getContentAreaContainer() || x.getBody()));
            var g,
              p,
              v,
              b = D.getUiContainerDelta(s).getOr({ x: 0, y: 0 });
            if (
              ((r.x += b.x),
              (r.y += b.y),
              (i.x += b.x),
              ...
              (o.x += b.x),
              (o.y += b.y),
              'inline' !== O.getStyle(e.element, 'display', !0))
            ) {
              var y = e.element.getBoundingClientRect();
              (r.w = y.width), (r.h = y.height);
            }
            x.inline || (o.w = x.getDoc().documentElement.offsetWidth),
              x.selection.controlSelection.isResizable(e.element) && r.w < 25 && (r = R.inflate(r, 0, 8)),
              (n = R.findBestRelativePosition(i, r, o, l)),
              (r = R.clamp(r, o)),
              n
                ? ((a = R.relativePosition(i, r, n)), L(s, I(u, a.x, a.y, r, o, i)))
                : ((o.h += i.h),
                  (r = R.intersect(o, r))
                    ? (n = R.findBestRelativePosition(i, r, o, ['bc-tc', 'bl-tl', 'br-tr']))
                      ? ((a = R.relativePosition(i, r, n)), L(s, I(u, a.x, a.y, r, o, i)))
                      : L(s, I(u, r.x, r.y, r, o, i))
                    : s.hide()),
              (g = s),
              (v = function (e, t) {
                return e === t;
        ...
        a = function (e) {
          ...
          for (t = (i = x.$(e).parents().add(e)).length - 1; 0 <= t; t--)
            for (n = r.length - 1; 0 <= n; n--) if (r[n].predicate(i[t])) return { toolbar: r[n], element: i[t] };
          return null;
        };
    ...
    G = function (e, t) {
      for (var n = 0, i = e.length; n < i; n++) if (t(e[n], n, e)) return P.some(n);
      return P.none();
    },
    K = function (e, t) {
        ...
        a ||
          w.each(n, function (e, t) {
            ...
            e.context !== r ||
              ...
              e.prependToContext ? s.unshift(oe(t, e)) : s.push(oe(t, e)),
              'after' === e.separator && s.push({ name: '|', item: { text: '|' } }));
          }),
        (i.menu = ie.map(
          ((l = s),
          (u = t),
          (c = ie.filter(l, function (e) {
    ...
    pe = function (c, d, f) {
      return function (e) {
        ...
        (i = d),
          ...
          l && l.visible()
            ? (ge(u, l, 'onhide'), l.hide(), s.active(!1))
            : (l
                ? l.show()
                : ((l = v.create({ type: 'container', name: d, layout: 'stack', classes: 'sidebar-panel', html: '' })),
                  a.prepend(l),
                  ge(u, l, 'onrender')),
              ge(u, l, 'onshow'),
              s.active(!0)),
    ...
    _e = function (t, e, n) {
      var i, r, o, s, a;
      if (
        (!1 === m(t) && n.skinUiCss ? xe.styleSheetLoader.load(n.skinUiCss, ye(t)) : ye(t)(),
        (i = e.panel =
          v.create({
            type: 'panel',
            role: 'application',
            ...
            items: [
              {
                type: 'container',
                classes: 'top-part',
                items: [!1 === d(t) ? null : { type: 'menubar', border: '0 0 1 0', items: le(t) }, B(t, f(t))],
              },
              ve(t)
                ? ((s = t),
                  {
      ...
      return (
        ...
        n.width && xe.setStyle(i.getEl(), 'width', n.width),
  ...
  function Se(e, t, n) {
    ...
    return (
      (d = Me()),
      (o = (r = ke.getPos(t, D.getUiContainer(e))).x),
      (s = r.y),
      He(e) && Ee(document.body) && ((o -= d.x), (s -= d.y)),
      (i = e.getEl()),
      (a = (f = ke.getSize(i)).width),
      (l = f.height),
      (u = (f = ke.getSize(t)).width),
      (c = f.height),
      'b' === (n = (n || '').split(''))[0] && (s += c),
      'r' === n[1] && (o += u),
  ...
  var Me = function () {
    ...
    Te = function (e) {
      var t,
        n = D.getUiContainer(e);
      return n && !He(e) ? { x: 0, y: 0, w: (t = n).scrollWidth - 1, h: t.scrollHeight - 1 } : Me();
    },
    Pe = {
      ...
      moveTo: function (e, t) {
        ...
        return (
          s && Ee(s) && !He(n) && ((e -= s.scrollLeft), (t -= s.scrollTop)),
          s && ((e += 1), (t += 1)),
    ...
    ot = {
      ...
      init: function (t) {
        ...
        (i.settings = t = w.extend({}, i.Defaults, t)),
          ...
          (i._elmCache = {}),
          (i.$ = Re),
          (i.state = new Qe({ visible: !0, active: !1, disabled: !1, value: '' })),
          (i.data = new Qe(t.data)),
      ...
      initLayoutRect: function () {
        var e,
          ...
          d = c.settings,
          f = c.getEl();
        (e = c.borderBox = c.borderBox || Ae(f, 'border')),
          (c.paddingBox = c.paddingBox || Ae(f, 'padding')),
          (c.marginBox = c.marginBox || Ae(f, 'margin')),
          (u = ke.getSize(f)),
          (a = d.minWidth),
          (l = d.minHeight),
          (r = a || u.width),
          ...
          e
            ? ((i = a.deltaW),
              ...
              ((t = s._lastLayoutRect).x === a.x && t.y === a.y && t.w === a.w && t.h === a.h) ||
                ((o = Ze.repaintControls) && o.map && !o.map[s._id] && (o.push(s), (o.map[s._id] = !0)),
                (t.x = a.x),
                (t.y = a.y),
                (t.w = a.w),
                (t.h = a.h)),
      ...
      aria: function (e, t) {
        ...
        return void 0 === t
          ? n._aria[e]
          : ((n._aria[e] = t), n.state.get('rendered') && i.setAttribute('role' === e ? e : 'aria-' + e, t), n);
      },
      encode: function (e, t) {
        return (
      ...
      remove: function () {
        ...
        r &&
          ...
          r.items().set(t),
          (r._lastRect = null)),
          n._eventsRoot && n._eventsRoot === n && Re(i).off();
      ...
      postRender: function () {
        var e,
          ...
          o = this,
          s = o.settings;
        for (i in ((o.$el = Re(o.getEl())), o.state.set('rendered', !0), s))
  ...
  function st(n) {
    return (
      n._eventDispatcher ||
        (n._eventDispatcher = new De({
          scope: n,
          toggleEvent: function (e, t) {
            t &&
              De.isNative(e) &&
              (n._nativeEvents || (n._nativeEvents = {}), (n._nativeEvents[e] = !0), n.state.get('rendered') && at(n));
          },
        })),
      n._eventDispatcher
    );
  ...
  function at(a) {
    ...
    function c(e) {
      e.preventDefault(),
        'mousewheel' === e.type
          ? ((e.deltaY = -0.025 * e.wheelDelta), e.wheelDeltaX && (e.deltaX = -0.025 * e.wheelDeltaX))
      ...
      for (r in (d || (d = l._delegates = {}), i)) {
        ...
        'wheel' !== r || it
          ? ('mouseenter' === r || 'mouseleave' === r
              ? l._hasMouseEnter || (Re(l.getEl()).on('mouseleave', s).on('mouseover', u), (l._hasMouseEnter = 1))
              : d[r] || (Re(l.getEl()).on(r, o), (d[r] = !0)),
            (i[r] = !1))
          : nt
          ? Re(a.getEl()).on('mousewheel', c)
          : Re(a.getEl()).on('DOMMouseScroll', c);
      }
    }
  }
  ...
  var dt = {},
    ft = lt.extend({
      ...
      replace: function (e, t) {
        ...
        0 <= r && ((n = t.getEl()) && n.parentNode.removeChild(n), (n = e.getEl()) && n.parentNode.removeChild(n)),
          t.parent(this);
      },
      create: function (e) {
        var t,
            ...
            e.parent(i),
              e.state.get('rendered') ||
                ((n = i.getEl('body')).hasChildNodes() && t <= n.childNodes.length - 1
                  ? Re(n.childNodes[t]).before(e.renderHtml())
                  : Re(n).append(e.renderHtml()),
                e.postRender(),
                tt.add(e));
          }),
      ...
      insert: function (e, t, n) {
        ...
        return (
          ...
          (i = this.items()),
          !n && t < i.length - 1 && (t += 1),
          0 <= t && t < i.length && ((r = i.slice(0, t).toArray()), (o = i.slice(t).toArray()), i.set(r.concat(e, o))),
          this.renderNew()
        );
      },
      fromJSON: function (e) {
      ...
      postRender: function () {
        ...
        return (
          ...
          t.parent() || (t.keyboardNav = ct({ root: t })),
          t
        );
      },
      initLayoutRect: function () {
      ...
      recalc: function () {
        ...
        if (!n || n.w !== t.w || n.h !== t.h)
          return e._layout.recalc(e), (t = e.layoutRect()), (e._lastRect = { x: t.x, y: t.y, w: t.w, h: t.h }), !0;
      },
      reflow: function () {
        var e;
        if ((tt.remove(this), this.visible())) {
          for (
            lt.repaintControls = [], lt.repaintControls.map = {}, this.recalc(), e = lt.repaintControls.length;
            e--;

          )
            lt.repaintControls[e].repaint();
    ...
    (t = function (e) {
      ...
      ht(e),
        ...
        (m = Re('<div></div>')
          ...
          .appendTo(x.body)),
        Re(x).on('mousemove touchmove', v).on('mouseup touchend', p),
        h.start(e);
    }),
      (v = function (e) {
        ...
        function n() {
          ...
          function t(e, t, n, i, r, o) {
            ...
            if ((a = p.getEl('scroll' + e))) {
              if (
                ((f = t.toLowerCase()), (h = n.toLowerCase()), Re(p.getEl('absend')).css(f, p.layoutRect()[i] - 1), !r)
              )
                return void Re(a).css('display', 'none');
              Re(a).css('display', 'block'),
                (s = p.getEl('body')),
    ...
    xt = ft.extend({
      ...
      renderHtml: function () {
        ...
        return (
          ...
          t.preRender(e),
          void 0 === n
            ? (n = '<div id="' + e._id + '-body" class="' + e.bodyClasses + '">' + t.renderHtml(e) + '</div>')
    ...
    r.settings.autofix &&
      (r.state.get('fixed')
        ...
        : ((r._autoFixY = r.layoutRect().y),
          r._autoFixY < e && (r.fixed(!0).layoutRect({ y: 0 }).repaint(), t(!0, e - r._autoFixY))));
  }
  function Ht(e, t) {
    var n,
      i,
      r = St.zIndex || 65535;
    if (e) Rt.push(t);
    else for (n = Rt.length; n--; ) Rt[n] === t && Rt.splice(n, 1);
    if (Rt.length)
      for (n = 0; n < Rt.length; n++)
        Rt[n].modal && (r++, (i = Rt[n])), (Rt[n].getEl().style.zIndex = r), (Rt[n].zIndex = r), r++;
      ...
      i._super(e),
            ...
            if (!vt) {
              ...
              (vt = function () {
                (document.all && t === e.clientWidth && n === e.clientHeight) ||
                  ((t = e.clientWidth), (n = e.clientHeight), St.hideAll());
              }),
        ...
        i.on('postrender show', function (e) {
          if (e.control === i) {
            ...
            i.modal &&
              !bt &&
              ((t = Re('#' + n + 'modal-block', i.getContainerElm()))[0] ||
                (t = Re('<div id="' + n + 'modal-block" class="' + n + 'reset ' + n + 'fade"></div>').appendTo(
                  i.getContainerElm()
                )),
          ...
          a
            ...
            : ((a = e.panel =
                v.create({
                  ...
                  fixed: Tt(n, s),
                  border: 1,
                  items: [!1 === d(s) ? null : { type: 'menubar', border: '0 0 1 0', items: le(s) }, B(s, f(s))],
                })),
              D.setUiContainer(s, a),
              x(s),
  ...
  function Wt(i, r) {
    ...
    (a.show = function (e, t) {
      function n() {
        o &&
          (Re(i).append('<div class="' + l + 'throbber' + (r ? ' ' + l + 'throbber-inline' : '') + '"></div>'),
          t && t());
      }
      ...
      (a.hide = function () {
        var e = i.lastChild;
        return (
          u.clearTimeout(s), e && -1 !== e.className.indexOf('throbber') && e.parentNode.removeChild(e), (o = !1), a
        );
      });
  }
  var Dt = function (e, t) {
    ...
    Nt = function (e, t, n) {
      ...
      return (
        ...
        Dt(e, t),
        e.getParam('inline', !1, 'boolean') ? Pt(e, t, n) : _e(e, t, n)
      );
    },
    At = lt.extend({
      Mixins: [Pe],
    ...
    Bt = lt.extend({
      ...
      tooltip: function () {
        return (
          this._tooltip ||
            ((this._tooltip = new At({ type: 'tooltip' })),
            D.inheritUiContainer(this, this._tooltip),
  ...
  function It(o) {
    ...
    return {
      open: function (e, t) {
        var n,
          i = w.extend(e, { maxWidth: ((n = s(o)), ke.getSize(n).width) }),
          r = new Lt(i);
        return (
          0 < (r.args = i).timeout &&
  ...
  function Vt(e) {
    var t,
      n = Re('meta[name=viewport]')[0];
    !1 !== me.overrideViewPort &&
      (n ||
        ((n = document.createElement('meta')).setAttribute('name', 'viewport'),
        document.getElementsByTagName('head')[0].appendChild(n)),
      (t = n.getAttribute('content')) && void 0 !== Ut && (Ut = t),
      n.setAttribute(
        'content',
        e ? 'width=device-width,initial-scale=1.0,user-scalable=0,minimum-scale=1.0,maximum-scale=1.0' : Ut
      ));
  }
  function jt(e, t) {
    (function () {
      for (var e = 0; e < Ft.length; e++) if (Ft[e]._fullscreen) return !0;
      return !1;
    })() &&
      !1 === t &&
      Re([document.documentElement, document.body]).removeClass(e + 'fullscreen');
  }
  var qt = St.extend({
    modal: !0,
    Defaults: {
    ...
    recalc: function () {
      var e,
        ...
        r = this,
        o = r.statusbar;
      r._fullscreen && (r.layoutRect(ke.getWindowSize()), (r.layoutRect().contentH = r.layoutRect().innerH)),
        r._super(),
        (e = r.layoutRect()),
        r.settings.title &&
          !r._fullscreen &&
      ...
      if (e !== i._fullscreen)
        if (
          ...
          (i._initial = { x: t.x, y: t.y, w: t.w, h: t.h }),
            ...
            Re([r, document.body]).addClass(o + 'fullscreen'),
          ...
          (i.borderBox = Ne(i.settings.border)),
            ...
            (t.deltaH += t.headerH),
            Re([r, document.body]).removeClass(o + 'fullscreen'),
    ...
    postRender: function () {
      ...
      setTimeout(function () {
        ...
        n.focus(),
        (this.dragHelper = new mt(n._id + '-dragh', {
          start: function () {
  ...
  !(function () {
    if (!me.desktop) {
      ...
      u.setInterval(function () {
        ...
        (n.w === e && n.h === t) || ((n = { w: e, h: t }), Re(window).trigger('resize'));
      }, 100);
    }
    Re(window).on('resize', function () {
      var e,
      ...
      for (e = 0; e < Ft.length; e++)
        (t = Ft[e].layoutRect()),
          Ft[e].moveTo(
            Ft[e].settings.x || Math.max(0, n.w / 2 - t.w / 2),
            Ft[e].settings.y || Math.max(0, n.h / 2 - t.h / 2)
          );
    });
  })();
  var Yt,
    $t = qt.extend({
      ...
      Statics: {
        ...
        alert: function (e, t) {
          return 'string' == typeof e && (e = { text: e }), (e.callback = t), $t.msgBox(e);
        },
        confirm: function (e, t) {
          return 'string' == typeof e && (e = { text: e }), (e.callback = t), (e.buttons = $t.OK_CANCEL), $t.msgBox(e);
        },
      },
    }),
    Xt = function (n) {
    ...
    Zt = Kt.extend({
      ...
      postRender: function () {
        var n = this,
          t = ke.create('input', { type: 'file', id: n._id + '-browse', accept: n.settings.accept });
        n._super(),
          Re(t).on('change', function (e) {
    ...
    nn = Bt.extend({
      ...
      repaint: function () {
        ...
        n.statusLevel() &&
          'none' !== n.statusLevel() &&
          (s =
            parseInt(ke.getRuntimeStyle(a, 'padding-right'), 10) - parseInt(ke.getRuntimeStyle(a, 'padding-left'), 10)),
          (e = r ? o.w - ke.getSize(r).width - 10 : o.w - 10);
        var l = document;
        return (
          l.all && (!l.documentMode || l.documentMode <= 8) && (t = n.layoutRect().h - 2 + 'px'),
          Re(a).css({ width: e - s, lineHeight: t }),
          n._super(),
          n
        );
      },
      postRender: function () {
        var t = this;
        return (
          Re(this.getEl('inp')).on('change', function (e) {
      ...
      showAutoComplete: function (e, i) {
        ...
        if (0 !== e.length) {
          r.menu
            ? r.menu.items().remove()
            : (r.menu = v.create({ type: 'menu', classes: 'combobox-menu', layout: 'flow' }).parent(r).renderTo()),
            w.each(e, function (e) {
              var t, n;
              r.menu.add({
                text: e.title,
        ...
        r.state.on('change:value', function (e) {
          ...
          r.state.on('change:statusLevel', function (e) {
            var t = r.getEl('status'),
              n = r.classPrefix,
              i = e.value;
            ke.css(t, 'display', 'none' === i ? 'none' : ''),
              ke.toggleClass(t, n + 'i-checkmark', 'ok' === i),
              ke.toggleClass(t, n + 'i-warning', 'warn' === i),
              ke.toggleClass(t, n + 'i-error', 'error' === i),
          ...
          r.on('keydown', function (e) {
            ...
            'INPUT' === e.target.nodeName &&
              (t === tn.DOWN
                ...
                : t === tn.UP && (e.preventDefault(), n(-1, r.menu)));
          }),
          r._super()
        );
      },
    ...
    on = Kt.extend({
      showPanel: function () {
        ...
        var i = t.panel.testMoveRel(
          t.getEl(),
          e.popoverAlign ||
            (t.isRtl() ? ['bc-tc', 'bc-tl', 'bc-tr'] : ['bc-tc', 'bc-tr', 'bc-tl', 'tc-bc', 'tc-br', 'tc-bl'])
        );
      ...
      postRender: function () {
        ...
        return (
          ...
          t.on('click', function (e) {
            e.control === t &&
              (t.panel && t.panel.visible() ? t.hidePanel() : (t.showPanel(), t.panel.focus(!!e.aria)));
          }),
          t._super()
        );
      },
        ...
        return (
          t.on('click', function (e) {
            (e.aria && 'down' === e.aria.key) ||
              e.control !== t ||
              sn.getParent(e.target, '.' + t.classPrefix + 'open') ||
    ...
    un = Bt.extend({
      ...
      postRender: function () {
        ...
        function c(e, t) {
          var n = (360 - e.h) / 360;
          ke.css(r, { top: 100 * n + '%' }),
            t || ke.css(s, { left: e.s + '%', top: 100 - e.v + '%' }),
            (o.style.background = ln({ s: 100, v: 100, h: e.h }).toHex()),
        ...
        (i = a.getEl('h')),
          ...
          a._super(),
          (a._svdraghelper = new mt(a._id + '-sv', { start: e, drag: e })),
          (a._hdraghelper = new mt(a._id + '-h', { start: t, drag: t })),
          a._repaint();
      },
      rgb: function () {
    ...
    cn = Bt.extend({
      ...
      renderHtml: function () {
        ...
        return (
          ...
          (t = ke.create('div', e, '<span>' + this.translate(n.text) + '</span>')),
          n.height && ke.css(t, 'height', n.height + 'px'),
          n.width && ke.css(t, 'width', n.width + 'px'),
            ...
            s.on('nodeChange', function (e) {
              for (var t = [], n = e.parents, i = n.length; i--; )
                if (1 === n[i].nodeType && !a(n[i])) {
                  ...
                  if ((r.isDefaultPrevented() || t.push({ name: r.name, element: n[i] }), r.isPropagationStopped()))
                    break;
                }
              o.row(t);
            })),
      ...
      renderHtml: function () {
        ...
        return (
          ...
          '<div id="' +
            ...
            (e.settings.title
              ? '<div id="' + e._id + '-title" class="' + n + 'title">' + e.settings.title + '</div>'
              : '') +
            '<div id="' +
            e._id +
            '-body" class="' +
          ...
          e.each(function (e) {
            ...
            n &&
              (((t = new hn(
                w.extend(
                  {
                    items: { type: 'label', id: e._id + '-l', text: n, flex: 0, forId: e._id, disabled: e.disabled() },
                  },
                  i.settings.formItemDefaults
                )
              )).type = 'formitem'),
      ...
      renderHtml: function () {
        ...
        return (
          ...
          '<fieldset id="' +
            ...
            '" hidefocus="1" tabindex="-1">' +
            (e.settings.title
              ? '<legend id="' + e._id + '-title" class="' + n + 'fieldset-title">' + e.settings.title + '</legend>'
              : '') +
            '<div id="' +
            e._id +
            '-body" class="' +
    ...
    An = {
      ...
      immutableBag: function (r, o) {
        ...
        return (
          Nn.validateStrArr('required', r),
          Nn.validateStrArr('optional', o),
          Nn.checkDupes(s),
          function (t) {
            var n = Wn.keys(t);
    ...
    Vn = {
      unknown: function () {
        return Un({ current: undefined, version: Ln.unknown() });
      },
      nu: Un,
    ...
    Gn = {
      unknown: function () {
        return Jn({ current: undefined, version: Ln.unknown() });
      },
      nu: Jn,
    ...
    ii = [
      ...
      { name: 'Opera', versionRegexes: [ti, /.*?opera\/([0-9]+)\.([0-9]+).*/], search: ni('opera') },
      { name: 'Firefox', versionRegexes: [/.*?firefox\/\ ?([0-9]+)\.([0-9]+).*/], search: ni('firefox') },
      {
        name: 'Safari',
    ...
    ri = [
      { name: 'Windows', search: ni('win'), versionRegexes: [/.*?windows\ nt\ ?([0-9]+)\.([0-9]+).*/] },
      {
        name: 'iOS',
        search: function (e) {
      ...
      { name: 'Android', search: ni('android'), versionRegexes: [/.*?android\ ?([0-9]+)\.([0-9]+).*/] },
      { name: 'OSX', search: ni('os x'), versionRegexes: [/.*?os\ x\ ?([0-9]+)_([0-9]+).*/] },
      { name: 'Linux', search: ni('linux'), versionRegexes: [] },
      { name: 'Solaris', search: ni('sunos'), versionRegexes: [] },
      { name: 'FreeBSD', search: ni('freebsd'), versionRegexes: [] },
    ],
    oi = { browsers: k.constant(ii), oses: k.constant(ri) },
    si = function (e) {
      var t,
        n,
        i,
    ...
    ki = function (e) {
      ...
      return (
        ...
        (n = e),
        ie.map(fi(yn.fromDom(n), t), function (e) {
          return e.dom();
        })
      );
    },
    ...
    Ti = function (e, t) {
      return { title: e, value: { title: e, url: t, attach: k.noop } };
    },
    Pi = function (e, t, n) {
      var i = t in e ? e[t] : n;
      return !1 === i ? null : i;
      ...
      var n,
        ...
        u = function (e) {
          ...
          return w.map(n, function (e) {
            return { title: e, value: { title: e, url: e, attach: k.noop } };
          });
        },
        c = function (t) {
          var e,
            n = ie.filter(i, function (e) {
              return e.type === t;
            });
      ...
      return !1 === t.typeahead_urls
        ...
        ? ((n = [
            ...
            Di(
              e,
              ((o = c('anchor')),
              (s = Pi(t, 'anchor_top', '#top')),
              (a = Pi(t, 'anchor_bottom', '#bottom')),
              null !== s && o.unshift(Ti('<top>', s)),
              null !== a && o.push(Ti('<bottom>', a)),
              o)
            ),
          ]),
          ie.foldl(
        ...
        r.on('PostRender', function () {
          r.getRoot().on('submit', function (e) {
            ...
            e.isDefaultPrevented() ||
              ...
              (i = Si[(n = s)]),
              /^https?/.test(t) &&
                (i ? ie.indexOf(i, t).isNone() && (Si[n] = i.slice(0, 5).concat(t)) : (Si[n] = [t])));
          });
        });
    },
    Ai = function (o, e, n) {
    ...
    Oi = Gt.extend({
      recalc: function (e) {
        ...
        e.items()
          .filter(':visible')
          .each(function (e) {
            e.layoutRect({ x: n.left, y: n.top, w: t.innerW - n.right - n.left, h: t.innerH - n.top - n.bottom }),
              e.recalc && e.recalc();
          });
      },
    }),
    zi = Gt.extend({
      recalc: function (e) {
        ...
        for (
          ...
          (m = (h = i[t]).layoutRect()),
            (d -= t < n - 1 ? u : 0),
            0 < (g = h.settings.flex) && ((c += g), m[k] && z.push(h), (m.flex = g)),
            (d -= m[R]),
            w < (p = o[N] + m[D] + o[A]) && (w = p);
        if (
    ...
    Vi = function (n) {
      n.addMenuItem('align', {
        text: 'Align',
        menu: [
          { text: 'Left', icon: 'alignleft', onclick: Fi(n, 'alignleft') },
          { text: 'Center', icon: 'aligncenter', onclick: Fi(n, 'aligncenter') },
          { text: 'Right', icon: 'alignright', onclick: Fi(n, 'alignright') },
          { text: 'Justify', icon: 'alignjustify', onclick: Fi(n, 'alignjustify') },
        ],
      }),
        w.each(
          {
          ...
          function (e, t) {
            n.addButton(t, { active: !1, tooltip: e[0], cmd: e[1], onPostRender: Ui(n, t) });
          }
        );
    },
    ji = function (e) {
    ...
    Xi = function (e, t) {
      return /[0-9.]+px$/.test(e)
        ? ((n = (72 * parseInt(e, 10)) / 96), (i = t || 0), (r = Math.pow(10, i)), Math.round(n * r) / r + 'pt')
        : e;
      var n, i, r;
    },
    Ji = function (e, t, n) {
            ...
            itemDefaults: {
              ...
              onPostRender: function () {
                ...
                n.parent().on('show', function () {
                  var e, t;
                  (e = n.settings.format) && (n.disabled(!i.formatter.canApply(e)), n.active(i.formatter.match(e))),
                    (t = n.settings.cmd) && n.active(i.queryCommandState(t));
                });
              },
              onclick: function () {
                this.settings.format && Fi(i, this.settings.format)(),
    ...
    lr = function (e) {
      ...
      (n = e),
        w.each(
          ...
          function (e, t) {
            n.addButton(t, { active: !1, tooltip: e, onPostRender: Ui(n, t), onclick: Fi(n, t) });
          }
        ),
        (i = e),
        w.each(
        ...
        w.each(
          ...
          function (e, t) {
            r.addButton(t, { active: !1, tooltip: e[0], cmd: e[1], onPostRender: Ui(r, t) });
          }
        );
    },
    ur = function (e) {
      ...
      lr(e),
        ...
        n.addMenuItem('codeformat', { text: 'Code', icon: 'code', onclick: Fi(n, 'code') });
    },
    cr = function (n, i) {
      return function () {
        var e = this,
    ...
    dr = function (e) {
      ...
      (t = e).addMenuItem('undo', {
        ...
        (n = e).addButton('undo', { tooltip: 'Undo', onPostRender: cr(n, 'undo'), cmd: 'undo' }),
        n.addButton('redo', { tooltip: 'Redo', onPostRender: cr(n, 'redo'), cmd: 'redo' });
    },
    fr = function (e) {
      var t, n;
      ...
      setup: function (e) {
        ...
        e.rtl && (lt.rtl = !0),
          ...
          (t = e).settings.ui_container &&
            (me.container = Ii(yn.fromDom(document.body), t.settings.ui_container).fold(k.constant(null), function (e) {
              return e.dom();
            })),
          (Bt.tooltips = !me.iOS),
          (lt.translate = function (e) {
    ...
    mr = Gt.extend({
      recalc: function (e) {
        ...
        if (
          ...
          var P;
          o.autoResize && (((l = e.layoutRect(l)).contentW = l.minW - o.deltaW), (l.contentH = l.minH - o.deltaH)),
          ...
          for (m = p.top, f = 0; f < n; f++) {
            for (h = p.left, a = T[f] + P, d = 0; d < i && (c = r[S ? f * i + i - 1 - d : f * i + d]); d++)
              (g = c.settings),
                (u = c.layoutRect()),
      ...
      initLayoutRect: function () {
        ...
        return (
          e.settings.multiline &&
            (ke.getSize(e.getEl()).width > t.maxW && ((t.minW = t.maxW), e.classes.add('multiline')),
            (e.getEl().style.width = t.minW + 'px'),
            (t.startMinH = t.h = t.minH = Math.min(t.maxH, ke.getSize(e.getEl()).height))),
          t
        );
      },
      repaint: function () {
    ...
    xr = Kt.extend({
      ...
      renderHtml: function () {
        ...
        return (
          ...
          t.aria('role', t.parent() instanceof yr ? 'menuitem' : 'button'),
          '<div id="' +
            n +
            '" class="' +
            t.classes +
    ...
    wr = St.extend({
      ...
      load: function () {
        ...
        n.settings.itemsFactory &&
          (n.throbber ||
            ((n.throbber = new Wt(n.getEl('body'), !0)),
            0 === n.items().length
    ...
    Rr = Bt.extend({
      ...
      init: function (e) {
        ...
        n._super(e),
          ...
          e.selectable &&
            (n.aria('role', 'menuitemcheckbox'), n.classes.add('menu-item-checkbox'), (e.icon = 'selected')),
    ...
    Cr = en.extend({ Defaults: { classes: 'radio', role: 'radio' } }),
    kr = Bt.extend({
      renderHtml: function () {
        var e = this,
          t = e.classPrefix;
      ...
      postRender: function () {
        var t = this;
        t._super(),
          (t.resizeDragHelper = new mt(this._id, {
            start: function () {
              t.fire('ResizeStart');
            },
            drag: function (e) {
  ...
  function Tr(e, t) {
    ...
    'v' === e.settings.orientation
      ...
      : ((r = 'left'), (i = 'width'), (n = 'w')),
      (s = e.getEl('handle')),
      (o = ((e.layoutRect()[n] || 100) - ke.getSize(s)[i]) * ((t - e._minValue) / (e._maxValue - e._minValue)) + 'px'),
      (s.style[r] = o),
      (s.style.height = e.layoutRect().h + 'px'),
      Mr(s, 'valuenow', t),
      Mr(s, 'valuetext', '' + e.settings.previewFilter(t)),
      Mr(s, 'valuemin', e._minValue),
      Mr(s, 'valuemax', e._maxValue);
  }
  var Pr = Bt.extend({
      init: function (e) {
        var t = this;
        e.previewFilter ||
          ...
          (t._minValue = V.isNumber(e.minValue) ? e.minValue : 0),
          (t._maxValue = V.isNumber(e.maxValue) ? e.maxValue : 100),
      ...
      postRender: function () {
        ...
        (e = m._minValue),
          ...
          (function (o, s) {
            function t(e) {
              var t, n, i, r;
              (t = Sr((t = (((t = m.value()) + (r = n = o)) / ((i = s) - r) + 0.05 * e) * (i - n) - n), o, s)),
                m.value(t),
          ...
          (a = t),
          (l = m.getEl('handle')),
          (m._dragHelper = new mt(m._id, {
            handle: m._id + '-handle',
            start: function (e) {
              (u = e[n]),
                (c = parseInt(m.getEl('handle').style[i], 10)),
                (d = (m.layoutRect()[o] || 100) - ke.getSize(l)[r]),
    ...
    Dr = xr.extend({
      ...
      repaint: function () {
        ...
        return (
          ...
          (e = n.firstChild),
          (t = n.lastChild),
          Re(e).css({ width: i.w - ke.getSize(t).width, height: i.h - 2 }),
          Re(t).css({ height: i.h - 2 }),
          this
        );
      },
      activeMenu: function (e) {
    ...
    Ar = xt.extend({
      ...
      activateTab: function (n) {
        ...
        this.activeTabId &&
          ...
          Re(e).removeClass(this.classPrefix + 'active'),
          e.setAttribute('aria-selected', 'false')),
          (this.activeTabId = 't' + n),
          (e = this.getEl('t' + n)).setAttribute('aria-selected', 'true'),
          Re(e).addClass(this.classPrefix + 'active'),
      ...
      initLayoutRect: function () {
        var e,
          ...
          n,
          i = this;
        (t = (t = ke.getSize(i.getEl('head')).width) < 0 ? 0 : t),
          (n = 0),
          i.items().each(function (e) {
    ...
    Br = Bt.extend({
      ...
      renderHtml: function () {
        ...
        return (
          ...
          ((e = ke.create(i.multiline ? 'textarea' : 'input', t)).value = n.state.get('value')),
          (e.className = n.classes),
          e.outerHTML
        );
      },
      value: function (e) {
  ...
  w.each(Or(), function (e, t) {
    ...
    zr(window.tinymce ? window.tinymce : {}),
