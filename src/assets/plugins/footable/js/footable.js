...
(function (F) {
  ...
  F.is.fn = function (value) {
    return (
      (F.is.defined(window) && value === window.alert) || '[object Function]' === Object.prototype.toString.call(value)
    );
  };
  ...
  F.Cell = F.Class.extend(
    /** @lends FooTable.Cell */ {
      ...
      define: function (valueOrElement) {
        ...
        var hasOptions =
          F.is.hash(valueOrElement) && F.is.hash(valueOrElement.options) && F.is.defined(valueOrElement.value);
      ...
      draw: function ($parent) {
        ...
        F.arr.each(self.cells, function (cell) {
          ...
          if (self.ft.rows.showToggle && self.ft.columns.hasHidden) {
            if (
              (self.ft.rows.toggleColumn == 'first' && cell.column.index == self.ft.columns.firstVisibleIndex) ||
    ...
    /** @lends FooTable.Filtering */ {
      ...
      _ensure: function (filter, selectedColumns) {
        if (
          ...
          filter.space =
            F.is.string(filter.space) && (filter.space === 'AND' || filter.space === 'OR') ? filter.space : this.space;
...
(function ($, F) {
  F.EditingColumn = F.Column.extend(
    /** @lends FooTable.EditingColumn */ {
       ...
       */
      $create: function () {
        (this.$el = !this.virtual && F.is.jq(this.$el) ? this.$el : $('<th/>', { class: 'footable-editing' })).html(
          this.title
        );
      },
      /**
