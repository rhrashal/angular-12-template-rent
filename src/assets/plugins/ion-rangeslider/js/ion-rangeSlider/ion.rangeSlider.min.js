  ...
  r.prototype = {
    ...
    append: function () {
      ...
      this.options.disable
        ...
        : (this.$cache.cont.removeClass('irs-disabled'), (this.$cache.input[0].disabled = !1), this.bindEvents());
    ...
    pointerMove: function (a) {
      this.dragging &&
        ((this.coords.x_pointer =
          (a.pageX || (a.originalEvent.touches && a.originalEvent.touches[0].pageX)) - this.coords.x_gap),
        this.calc());
    },
        ...
        if (this.coords.w_rs && (this.dragging || this.force_redraw || this.is_key)) {
          if (
            ...
            if (this.is_key || this.is_click || this.is_first_update)
              (this.is_first_update = this.is_click = this.is_key = !1), this.callOnFinish();
    ...
    validate: function () {
      ...
      if (c)
        for (
          a.p_values = [], a.min = 0, a.max = c - 1, a.step = 1, a.grid_num = a.max, a.grid_snap = !0, g = 0;
          g < c;
          g++
        )
          (e = +d[g]), isNaN(e) ? (e = d[g]) : ((d[g] = e), (e = this._prettify(e))), a.p_values.push(e);
      ...
      'single' === a.type
        ...
        : (a.from < a.min && (a.from = a.min),
          ...
          this.update_check.from &&
            (this.update_check.from !== a.from && a.from > a.to && (a.from = a.to),
    ...
    appendGrid: function () {
      if (this.options.grid) {
        ...
        for (b = 0; b < c + 1; b++) {
          ...
          k = (g - e * (b - 1)) / (h + 1);
          for (d = 1; d <= h && 0 !== g; d++)
            (m = this.toFixed(g - k * d)), (n += '<span class="irs-grid-pol small" style="left: ' + m + '%"></span>');
