...
(function () {
  ...
  test('Correct initial levels shown', function () {
    ...
    equal(
      $(el.selector + ' ul li').length,
      9,
      'Correctly display 5 root, 2 children and 2 grand children nodes when levels set to 3'
    );
  });
  ...
  test('Selecting a node', function () {
    ...
    ok(
      $('.list-group-item:first').hasClass('node-selected'),
      'Node is correctly selected : class "node-selected" added'
    );
  ...
  test('Unselecting a node', function () {
    ...
    ok(
      !$('.list-group-item:first').hasClass('node-selected'),
      'Node is correctly unselected : class "node-selected" removed'
    );
  ...
  test('getSelected', function () {
    var $tree = init({ data: data }).treeview('selectNode', 0);
  ...
  test('getChecked', function () {
    var $tree = init({ data: data, showCheckbox: true }).treeview('checkNode', 0);
  ...
  test('getUnchecked', function () {
    var $tree = init({ data: data }).treeview('checkNode', 0);
  ...
  test('getDisabled', function () {
    var $tree = init({ data: data }).treeview('disableNode', 0);
  ...
  test('disableAll / enableAll', function () {
    ...
    equal(
      $($tree.selector + ' ul li.node-disabled').length,
      0,
      'Check all works, 9 nodes non with node-disabled class'
    );
  });
  ...
  test('disableNode / enableNode', function () {
    ...
    ok(
      !$('.list-group-item:first').hasClass('node-disabled'),
  ...
  test('toggleNodeDisabled', function () {
    ...
    ok(
      !$('.list-group-item:first').hasClass('node-disabled'),
      'Toggle node (by node) : Node does not have class node-disabled'
    );
  ...
  test('checkAll / uncheckAll', function () {
    ...
    equal(
      $($tree.selector + ' ul li .glyphicon-check').length,
      9,
      'Check all works, 9 nodes with glyphicon-check icon'
    );
    ...
    equal(
      $($tree.selector + ' ul li .glyphicon-unchecked').length,
      9,
      'Check all works, 9 nodes with glyphicon-unchecked icon'
    );
  });
  ...
  test('checkNode / uncheckNode', function () {
    ...
    ok(
      !$('.list-group-item:first').hasClass('node-checked'),
      'Uncheck node (by id) : Node does not have class node-checked'
    );
    ...
    ok(
      !$('.list-group-item:first').hasClass('node-checked'),
      'Uncheck node (by node) : Node does not have class node-checked'
    );
  ...
  test('toggleNodeChecked', function () {
    ...
    ok(
      !$('.list-group-item:first').hasClass('node-checked'),
      'Toggle node (by node) : Node does not have class node-checked'
    );
  ...
  test('selectNode / unselectNode', function () {
    ...
    ok(
      !$('.list-group-item:first').hasClass('node-selected'),
      'Unselect node (by id) : Node does not have class node-selected'
    );
    ...
    ok(
      !$('.list-group-item:first').hasClass('node-selected'),
      'Unselect node (by node) : Node does not have class node-selected'
    );
  ...
  test('toggleNodeSelected', function () {
    ...
    ok(
      !$('.list-group-item:first').hasClass('node-selected'),
      'Toggle node (by id) : Node does not have class node-selected'
    );
  ...
  test('revealNode', function () {
    ...
    equal(
      $($tree.selector + ' ul li').length,
      9,
      'Reveal node (by node) works, reveal Grandchild 1 and 9 nodes displayed'
    );
  });
