      ...
      return (
        this.each(function () {
          ...
          function r(e, t, i) {
            ...
            if (
              (t &&
                ((o = parseInt(R.css('top')) + ((e * parseInt(s.wheelStep)) / 100) * R.outerHeight()),
          ...
          if (x.parent().hasClass(s.wrapperClass)) {
            ...
            var S = e(w)
              ...
              .css({ position: 'relative', overflow: 'hidden', width: s.width, height: s.height });
            ...
            E.css(D),
              ...
              'bottom' === s.start
                ...
                : 'top' !== s.start && (r(e(s.start).position().top, null, !0), s.alwaysVisible || R.hide()),
              a(this);
          }
        }),
        this
