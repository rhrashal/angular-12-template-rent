$(function () {
  ...
  $(window).ready(i),
    ...
    (function (i, e, s) {
      i('[data-perform="card-collapse"]').each(function () {
        var e = i(this),
          s = e.closest('.card'),
          o = s.find('.card-block'),
          l = { toggle: !1 };
        o.length ||
          ((o = s.children('.card-heading').nextAll().wrapAll('<div/>').parent().addClass('card-block')), (l = {})),
          o
            .collapse(l)
        ...
        i(s).on('click', '[data-perform="card-collapse"]', function (e) {
          e.preventDefault(), i(this).closest('.card').find('.card-block').collapse('toggle');
        });
